label dct_dragon:
    ...
    "Дверь, обитая старым, дышащим на ладан, дермантином, кнопка звонка на уровне, чуть выше пояса, чтобы внучке было удобно.{w} Вот только внучка эта давно выросла и уехала."
    ...
    "Когда-то в них дрова хранились, а в шестидесятых, еще до моего рождения, в дома газ провели. Газ провели, а сараи остались."
    ...
    show dct_dream_veil at shiver
    with pixellate
    "Наши должны уже собраться у крайнего сарая. Так и есть, вон они сидят и дымят: четверо в карты режутся, Миха с мотоциклом ковыряется, Миха-большой на турнике повис. Венька, как обычно, чуть в стороне и в книжку уткнулся."
    ...
    "Иду к остановке, а Венька увязывается со мной."
