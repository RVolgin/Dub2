...
label dct_olga_p1:
    ...
    th "До ужина еще часа четыре. Что там мне посоветовали? Погулять? Вот пойду и погуляю."
    stop ambience
    ...
    dreamgirl "Несмотря на плохое первое впечатление поселок Ольге скорее понравился. Пляж, стадион, лодочная станция, лес. Расслабленная атмосфера, шорты, футболки, короткие юбки и легкие платья, яркие цвета в одежде. И только изредка попадающиеся военные хранили верность своей форме."
    ...
    th "День прошел. Будем считать это однодневной путевкой в профилакторий."
    th "На пляже я была, по лесу погуляла. Осталось, для того чтобы поставить галочку, потанцевать, пофлиртовать и что там еще делают в домах отдыха."
...
label dct_olga_p2:
    ...
    d_gd "Особенно всем нам будет неприятно, если всплывет правда о том, что Система вышла из под контроля. И так применение Выключателя по активным НБО с трудом обосновали."
    d_to "Может, рискнем и отправим её, скажем, в первый узел. Всё равно лагеря создавать надо."
    d_to "Цикла на три, а потом, когда она и Система адаптируются друг к другу, сделаем миксов и закроем вакансии во всех узлах."
    d_to "А её отчет автоматически окажется секретным, те кто имеет допуск — ничего не поймут, а кто поймут, те допуска не имеют."
    d_to "А что касается Выключателя: ты уверена, что была права?"
    show d_bg sad suit with dspr
    d_bg "Анатолий, я не знаю… Но другого выхода я не вижу и не видела."
    ...
    dreamgirl"Ольгу разбудил солнечный зайчик, неяркий, но настойчивый. Он щекотал лицо, пробиваясь между неплотно задернутыми занавесками, и совершенно не давал доспать."
    ...
    th "Надо было сдерзить: «фантастикой не увлекаюсь», но что-то страшновато. С таким Шуриком, пожалуй, даже царь Иван Васильевич поостерегся бы фамильярничать."
    ...
    $ set_mode_nvl ()
    "И разговор продолжился. То превращаясь в коллективную лекцию, то в перекрестный допрос. Иногда Ольга слушала раскрыв рот, иногда тряслась, как на экзамене."
    "Кажется экзаменаторов (или допрашивающих) интересовало про Ольгу буквально все: от успеваемости, до хобби, от школьных влюбленностей, до любимого времени года."
    "Но и она узнала не мало о том странном месте, куда привез её автобус."
    "Помалкивали двое: пожилая, на грани старости, женщина очень властного вида, кажется исполняющая обязанности здешнего директора, и мужчина с копной каштановых волос и такой же бородой, больше всего похожий на геолога из старого, еще черно-белого фильма."
    ...
    th "В этой истории есть один плюс: еще сутки здесь, на курорте, я получила."
    stop ambience
    ...
    play ambience dct_ambience_conf
    show adl_sh glasses normal at cright with moveinright
    dreamgirl "В кабинете Ольге действительно было сделано предложение, правда «Шурик», в начале, чуть было все не испортил."
    ...
    d_gd "Александр, ну при чем тут ваши взгляды?"
    hide adl_sh with moveoutright
    ...
    play ambience ambience_int_cabin_night
    d_mt2 "Да?"
    th "Половина четвертого. Кого еще несет?"
    ...
    dreamgirl "Офицер с повязкой на рукаве шел чуть впереди, показывая дорогу. Ольга отставала на полшага, а еще на два шага позади шел солдатик с вещмешком, замыкая процессию."
    ...
    dreamgirl "Солдату Ольгин чемодан не доверили, и офицер нес его самолично, держа в левой руке."
    stop ambience
    ...
    $ persistent.sprite_time = "night"
    play ambience ambience_camp_center_night
    dreamgirl "Ночные аллеи были пустынны, только один раз навстречу попались еще трое военных — тот самый патруль, судя по повязкам, заступиться перед которым обещал ей Анатолий."
    ...
    dreamgirl "Двери автобуса с шипением закрылись и автобус, мазнув фарами по кирпичному забору и воротам, развернулся и понес Ольгу сквозь южную ночь навстречу будущему."
    play ambience sfx_bus_interior_moving
    dreamgirl "Ольга поглядывала на вещмешок, стоящий на соседнем сидении, и вспоминала слова передавшего мешок офицера: «Это вам, на случай если что-то пойдет не так.»"
    dreamgirl "А потом офицер зеркально скопировал действия Анатолия, оглянувшись на того, маячущего в воротах: «И если все пойдет совсем не так, то послезавтра в двадцать три ноль-ноль на остановке будет автобус»."
    th "Как? Что? Что значит, не так?"
    dreamgirl "Что-то он знал, невзрачный капитан с повязкой дежурного по части."
    dreamgirl "А у Ольги впервые мелькнуло, еще даже не подозрение, а предчувствие подозрения, что утром в приёмной ей рассказали не всю правду. Но мелькнуло и исчезло."
    stop music fadeout 1
    stop ambience
...
label dct_olga_p3:
    ...
    show d_to normal casual with move:
        ypos 0.18
    d_to "В двадцать второй узел."
    d_gd "Вот именно. А почему не в первый, как было запланировано?"
    d_to "Первый был закрыт туманом."
    d_gd "Можно было подождать и отправить её днем. Опоздала бы к линейке, ничего страшного. Вы, мужчины, все, поголовно, авантюристы. Так что, готовьтесь к служебному несоответствию или к выговору. Смотря по результатам вашего эксперимента."
    stop music fadeout 1
    stop ambience
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_entrance_day
    dreamgirl "Тяжелый чемодан, тяжелый вещмешок… Ольга, пока допыхтела до двери, прокляла всё."
    ...
    dreamgirl "Было семь часов пятьдесят минут первого утра двухнедельного цикла. Впрочем, Ольга про циклы ничего не знала, для нее это было воскресенье, первый день смены."
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_center_day
    dreamgirl "Как вскоре выяснила Ольга, лагерь прекрасно функционировал и без нее. Пионеры… вот с пионерами было сложнее."
    ...
    dreamgirl "И пока Ольга, раздавая поручения, не противоречила этой силе — все было хорошо. Но стоило, например, поручить Лене…"
    stop ambience
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_center_day
    th "Или я схожу с ума, или надо мной изощренно издеваются. И, пожалуй, второе."
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_dining_hall_empty
    th "Как муравьи какие-то или пчелы."
    ...
    hide sl with dspr
    th "Страшно. Пойдешь в столовую, а там эти!"
    ...
    dreamgirl "Но не только в столовой, везде было страшно. Все время казалось, что стоит отвести взгляд, как пионеры за её спиной превращаются в бездушные механизмы."
    stop ambience
    ...
    th "Пара книг, журнал «Костер», так и не начатый дневник практики."
    ...
    th "А то, мало ли. Вдруг и на самом деле убегать и прятаться придется?"
    th "Я думала, что после того, как все прошлое лето проездила на поездах, будет проще. И тот чудак из поселка говорил что справлюсь."
    ...
    th "И все это с мертвым лицом и размеренными механическими движениями."
    ...
    play sound sfx_bus_honk
    th "Никуда я отсюда не уеду. Хотя бы ради этого цветка и этих дорожек от слез никуда не уеду."
    play sound dct_sfx_bus_departure
    ...
    #show sl normal pioneer close with fade
    $ renpy.pause (1)
    stop music fadeout 1
    stop sound
    stop ambience
    ...
    $ persistent.sprite_time = "night"
    play ambience ambience_int_cabin_night
    th "Они живые! Пусть им нельзя что-то делать и они не могут о чем-то говорить, но они живые."
    show blink
...
label dct_olga_p4:
    ...
    show d_to normal casual with move:
        ypos 0.18
    d_to "По мне так, адаптировалась больше чем следует. Когда новый цикл начнется — больно ей будет."
    d_gd "Анатолий, я не о том."
    d_to "А я так, именно что о том. Эмоциональную матрицу с нее сняли, параметры микса — разработаны. Осталось подготовить посредника и можно начинать процедуру."
    ...
    d_to "Ещё, Персунов предлагает запрограммировать биполярную модель поведения микса: ментор — сестренка. Такую модель проще с личностью оригинала совместить."
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_int_cabin_day
    dreamgirl "Вожатая проснулась задолго до горна и даже до звонка будильника. Не смотря на то что поздно легла, спать совершенно не хотелось."
    th "Это сейчас не хочется, а днем буду носом клевать — неудобно будет перед пионерами. Интересно, Славя тоже будет сонная ходить?"
    play music music_list["i_want_to_play"]
    #"И сразу же вспомнился вчерашний то ли поздний-поздний вечер, то ли ранняя-ранняя ночь. И появившаяся неизвестно откуда Славя, молча взявшая чемодан и несшая его до Ольгиного домика без видимых усилий."
    ...
    th "А мне еще же отчёт о практике писать. А до отчёта еще и план мероприятий."
    th "Видимо, придется сочинять. А еще придется учитывать «особенности» каждого пионера, чтобы не было таких проколов, как с Леной."
    ...
    th "Вот и первый пункт для отчета."
    stop music fadeout 1
    stop ambience
    ...
    th "Почему я вчера их боялась? Еще раз, спасибо тебе, Славя."
    ...
    "…"
    "{i}День первый.{/i}\n\nРазмещение пионеров по домикам, с учетом пола, возраста, характеров и пожеланий пионеров…\n"
    ...
    th "Говорят, что они все забудут, а я в это не верю."
    ...
    hide d_oz
    with easeoutright
    th "Так! Опять эти вампирчики в красных галстуках пьют кровь из бедной задерганной  вожатой! Ненавижу этих противных мелких кровососов! И кровососок тоже ненавижу!"
    ...
    show d_oz normal pioneer at right:
        zoom 1.25 ypos -0.3
    with easeinright
    mt "Что это за школа фехтования на метлах? Так, Оксанка, дай метлу на минутку!"
    ...
    d_sz "Эй! Тётя Оля, так не честно! Ты большая, а мы маленькие!"
    th "Только бы не расхохотаться, только бы не расхохотаться."
    mt "Ну что, мушкетеры? Сдулись? Тогда — подметайте."
    stop music fadeout 1
    stop ambience
    ...
    th "А хорошо!"
    th "Славя сейчас возьмет метлу и пойдет подметать остановку. Всё сама. Если хочешь сделать что-то хорошо — сделай это сам."
    ...
    play ambience ambience_camp_center_day
    play music music_list["dance_of_fireflies"]
    dreamgirl "Ночью, к северу от лагеря, прокатилась гроза. Удушающая жара, прижимавшая «Совенок» к земле последние четыре дня отпустила, и жить стало очень даже приятно."
    ...
    hide d_oz
    with dspr
    dreamgirl "Легкий ветерок, тянувший с реки, продувал насквозь жидкую рощу, отделявшую береговую линию от площади, и приятно шевелил волосы и гладил лицо."
    show blink
    ...
    dv "Ольга Дмитриевна…"
    dv "…Там… к вам пришли."
    mt "Алиса. Кто пришел и где это «Там»?"
    show dv shocked pioneer with dspr
    dv "Там… Там… Они вас ждут. Пойдемте пожалуйста, я провожу."
    ...
    mt "Зубными щетками площадь подмели?"
    mt "Не слышу!"
    stop ambience
    ...
    dreamgirl "Запал уже проходил, но его еще хватило бы для взбучки гостям."
    stop music fadeout 1
    stop ambience
    ...
    show d_ss normal shirt at left
    with dspr
    dreamgirl "Вот только гости оказались крепче нервами и сильнее тертыми жизнью, чем Ольгины пионеры, поэтому на них грозный вид вожатой не подействовал."
    d_to "Вот так оно и работает, Ольга Дмитриевна. Вот так здешние обитатели на обычных людей и реагируют."
    d_to "И когда вы проведете здесь какое-то время, на вас такая же реакция будет."
...
label dct_olga_p5:
    ...
    adl_sh3 "Не понимаю вас, Глафира Денисовна. Здесь ответственная работа, а вы держите на ней человека склонного к выпивке. А если это начнет повторяться каждую пятницу?"
    d_gd "Во-первых, не склонного, а, во-вторых, не начнет. Я, Александр, знаю причину и повод, а вы нет. Если у вас всё по этой теме, то давайте перейдем к делам Вашей лаборатории."
    stop music fadeout 1
    stop ambience
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_center_day
    dreamgirl "Ольга шла по поселку, невольно сравнивая его с лагерем."
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_center_day
    th "Это что, завтра мне опять начинать всё с начала? Неужели в них ничего не останется? А что будет через месяц, когда я уеду?"
    ...
    show d_ss normal shirt
    d_ss "В общем, Оля, остаться после практики здесь у вас нет возможности, но помочь обитателям «Совенка» у вас получится."
    stop ambience
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_int_cabin_day
    th "До обеда еще масса времени. Комнату убрала еще до завтрака, в бухгалтерии побывала, что там у меня дальше?"
    ...
    d_libr "Да, она тут самая старая будет, ей уже шестьдесят четыре. Сидит здесь безвылазно лет десять уже, не меньше. Только в отпуск на материк выбирается да еще зимой студентам лекции читает." 
    ...
    play ambience ambience_camp_center_day
    voice "Оля, подожди!"
    show d_ol normal far at cright with dissolve #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    d_ol "Оля, здравствуй. Меня зовут Олеся, я из лаборатории Семёна Семёновича."
    d_mt2 "Здравствуй, Олеся. А где он сам?"
    show d_ol shy far with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    d_ol "Он{w=0.8}, он занят. Его срочно на материк вызвали."
    show d_ol normal far with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    d_ol "Но это не важно. Потому что это я занимаюсь твоим проектом."
    d_ol "Приходи после обеда в лабораторный корпус, я тебе расскажу и покажу всё что есть."
    show d_ol smile far with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    ...
    show d_ol grin far with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    d_ol "Ты сможешь считать себя соавтором нового организма."
    stop ambience
    
    #ЦГ Олеси перед терминалом
    scene dct_int_laboratory_mt with squares
    $ day_time ()
    $ persistent.sprite_time = "day"
    play ambience ambience_clubs_inside_day
    play music music_list["i_want_to_play"]
    dreamgirl "Больше всего Ольге понравилось моделировать будущую личность своего будущего двойника."
    show d_ol smile at cleft with dissolve:  #Олеся, спрайт заглушка из "По ту сторону Совёнка"
        xzoom -1.0
    d_ol "Оль, не стесняйся, заказывай что хочешь."
    d_mt2 "Ну-у-у… значит так: возраст — чуть постарше, лет на пять, а то не солидно, когда вожатая почти ровесница своим пионерам."
    show d_ol normal with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    ...
    show d_ol grin with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    d_ol "Понятно, Оль. Сделаем."
    show d_ol smile with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    extend " А что по характеру? Что-то добавить хочешь?"
    d_mt2 "Добавить? Добавить{w=1}. Сейчас, подожди."
    ...
    scene dct_int_laboratory_mt with dissolve:
        zoom 1.2 anchor (384, 116)
    $ day_time ()
    $ persistent.sprite_time = "day"
    play ambience ambience_clubs_inside_day
    show d_ol normal close at fleft with dissolve:  #Олеся, спрайт заглушка из "По ту сторону Совёнка"
        xzoom -1.0
    ...
    d_mt2 "А мне Семён Семёнович говорил, что будет это мой двойник."
    d_ol "Не совсем двойник, Оль. У нее будет твоя внешность, с поправками. Она будет считать, что приехала вожатой в пионерский лагерь. У нее будут способности к педагогике. И у нее будут твои воспоминания, но не все."
    d_ol "А еще у неё будут воспоминания мои, бабы Глаши, шефа, вообще всех людей, которые были здесь. И она свяжет эти воспоминания своим воображением. И будет считать этот… это лоскутное одеяло своим прошлым."
    show d_ol shy close with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    ...
    d_ol "Он{w=1}… через неделю. Ну, пойдем в виварий."
    stop ambience
    ...
    show d_ol normal at cleft with dissolve:  #Олеся, спрайт заглушка из "По ту сторону Совёнка"
        xzoom -1.0
    ...
    show d_ol shy with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    d_ol "А обезьянки. Их конечно жалко, но нам их теперь удается спасти."
    stop ambience
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_clubs_inside_day
    show d_ol normal at right with dissolve #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    ...
    show d_ol normal far at right with dissolve #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    ...
    $ persistent.sprite_time = "night"
    play ambience ambience_camp_center_night
    show d_ol normal at left with dissolve:  #Олеся, спрайт заглушка из "По ту сторону Совёнка"
        xzoom -1.0
    d_ol "Ты, главное, за ворота не выглядывай, а то развернешь Систему на себя. А как я тебе скомандую, сразу бери веревку и тащи за нее тележку с клеткой сюда. А приборы техники утром заберут."
    dreamgirl "Ольга кивала, слушая путанный инструктаж Олеси. Потом, когда инструктаж кончился, а больше ничего не происходило, заскучала. И от скуки стала вслушиваться в треп сидящих в курилке техников-лаборантов."
    stop ambience
    ...
    d_vo_1 "Ты не знаешь? Набрал спирта в лаборатории и пьет. Копия у него активировалась."
...
label dct_olga_p6:
    ...
    #Олеся
    d_mt2 "Обезьянка!"
    show d_ol normal close with dissolve:  #Олеся, спрайт заглушка из "По ту сторону Совёнка"
        xzoom -1.0
    d_ol "Ты куда? Забыла, что я говорила? Сиди и терпи."
    d_mt2 "Но жалко же, Олеся."
    show d_ol shy close with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    d_ol "Мне тоже жалко. Но я сижу и терплю."
    show d_ol normal close with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    d_ol "А ты вообще хотела сама пойти вместо обезьянки. Не бойся, все идет как надо, я в первый раз тоже дергалась."
    ...
    d_ol "Знала бы ты, какое старье пользуем. Шеф такой умница, а ему финансирование все режут и режут. Как он результатов добивается — ума не приложу."
    ...
    th "Бедная."
    #Олеся
    d_ol "Кажется, все в порядке. Всё, Оль, больше ничего интересного не будет, можно идти по домам. Остальное всё техники сделают."
    d_tech_2 "Сделаем, сделаем, девочки. Сейчас скотинку коновалу сдадим, а утром за приборами вернемся."
    stop ambience
    ...
    play ambience ambience_camp_center_night
    play sound_loop dct_sfx_steps2
    dreamgirl "До площади всем было по пути. Техники продолжили свой разговор, но как Ольга не вслушивалась больше ничего интересного не услышала: говорили о футболе, о рыбалке и о политике."
    show d_ol normal at cright with dissolve #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    d_ol "Оль, вот ты среди {b}Них{/b} почти две недели жила. Это на две недели больше, чем любой из нас. Скажи пожалуйста, они — люди?"
    d_mt2 "Да.{w=0.8} Да."
    th "А ведь и правда: да. Даже такие, какие они были в первые дни, когда я хотела сбежать, они, где-то там, глубоко внутри, хранили человечность. Я же видела следы от слез на щеках у «механической» Слави."
    d_ol "Оль, я тоже думаю, что: да. То есть хочу так думать, но…"
    d_ol "Ты только никому не говори, потому что это секрет. Но у нас тут живет девочка из них."
    ...
    show d_ol shy with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    d_ol "Вот только каждый цикл она забывает все что узнала, и каждый цикл для нее начинается с того, что её папа привозит её сюда отдохнуть и чуть поработать, по четыре часа в день. Ну, это она считает так…"
    d_ol "Вот посмотришь на нее и кажется, что она — человек, ну пусть с проблемами с памятью. Но я же знаю, как они создаются. Мы сами с тобой сегодня одного создали. Людей так не делают."
    stop sound_loop
    show d_ol normal with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    d_ol "Ой, мы уже пришли. Тебе налево, а мне — направо. А тебе же еще собираться."
    show d_ol smile with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    ...
    scene dct_ext_residential_block_night with fade
    th "Олеся конечно шутила, что собирается пройти через это, чтобы не стареть. Но ведь кто-то же прошел, откуда-то это уже известно."
    scene dct_ext_residential_block_night with fade
    ...
    th "Интересно, это нервы, или это от того, что я смотрела туда, на клетку и туман за ней? Как там сказала Олеся: «обратила внимание системы на себя?» И что теперь будет? Нет, Олеся сказала Система с большой буквы. Что бы это не значило, но Система с большой буквы интересуется мной."
    ...
    mt "Здравствуй, Славя. Двадцать минут назад. Только знаешь, давай на вы, я все-таки ваша вожатая. А еще меня Ольга Дмитриевна зовут."
    ...
    th "Ничего не помнит. Жаль, но остальные наверное также."
...
label dct_olga_p7:
    ...
    th "Неужели не забыл ничего? Но они же все забывают. И начальство говорило, и Олеся подтвердила."
    ...
    th "Правда, она и прошлую смену уже начинала действовать без команды. Самая развитая из них."
    ...
    th "Изменилось моё к нему отношение — ничуть. Расскажу ли я ему правду про него — никогда."
    ...
    th "Но теперь понятно, что Сыроежкин делает в помещении кружков: все эти приборы и инструменты, они для него родные, и, кажется, понятно почему он ничего не делает в помещении кружков — ждет команды."
    ...
    mi "Но, Олечка Дмитриевна, каша всё равно вкусная. А вы стоите здесь уже полчаса и не садитетсь за стол. Так же нельзя, вот мне мама говорит…"
    mt "Уже сажусь, спасибо за заботу, Мику."
    hide mi with moveoutleft
    th "Сейчас позавтракую и пойду в библиотеку, там была печатная машинка. Нужно напечатать \"План мероприятий\" и вывесить его на стенд. С прошлой смены собираюсь."
    stop ambience
    ...
    show d_sm scared pioneer with dspr
    me "А вместо этого остались еще на смену! И все, все уверяют меня, что мы только сюда приехали! Даже Славя, ведет себя так, будто только познакомилась со мной! Скажите мне, что это сон, пожалуйста!"
    mt "Семён, Семён, успокойся. Сейчас во всем разберемся."
    ...
    d_to "Пойдемте на остановку, а то сейчас сюда толпа сбежится. Чувствуют они нас, пока без памяти."
    stop ambience
    ...
    show sl scared pioneer with dspr
    mt "Ну что ты, Славя, ведь он же вернется."
    show sl scared pioneer close with dspr
    sl "Да, вернется. Вы знаете, кто это? Это же… Это…"
    show sl surprise pioneer close with dspr 
    sl "Он точно вернется, Ольга Дмитриевна?"
    ...
    mt "Ну, пойдем, попробуем ещё раз."
    stop ambience
    ...
    d_ss "Добрая Глафира Денисовна. Тогда я пошел. Работать. Увидимся…"
    d_gd "Подожди. Ты в Подвале давно был?"
    d_ss "В Центре управления? Да вот, когда его замуровывали. Это, получается, три года назад."
    d_gd "А Толя спустился вниз, через памятник, на этой неделе, и не смог дальше первого уровня дорогу найти — все время ходил кругами. Потом до него дошло, что это первый виток спирального коридора, только замкнутый в кольцо."
    ...
    d_ss "Не надо меня успокаивать. Я и так все понимаю."
    d_gd "А я не успокаиваю, Семён. Я просто очень не хочу проснуться однажды одной из ячеек коллективного разума. И то, что мы делаем с пионерами, все равно лучше для пионеров, чем Такая участь."
    d_gd "Можешь следующего активированного пионера взять в свою лабораторию и сам убедиться. Один-то пионер погоды не сделает. Только с одним условием: ты все ему расскажешь."
    stop music fadeout 1
    stop ambience
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_int_cabin_day
    show d_ss normal sweater at right
    show d_to normal casual at left
    d_to "Ты как, Семён Семёныч?"
    d_ss "Переживу. Бывало и больнее."
    d_to "Чтобы между нами было честно: обнулял его лично я. Минимальным импульсом. Так что, есть большой шанс, что он очнется, циклов через пять. И тогда забирай его, как договорился с бабулей. Но это всё, что я могу для тебя сделать."
    ...
    "И со Славей у него ничего не вышло. Или это у Слави с ним ничего не вышло? Не известно."
    $ set_mode_adv ()
    mt "Славя, ты плачешь?"
    show sl sad pioneer with dspr
    window auto
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_dining_hall_empty
    th "Ну что, всё чисто, все столы протерты, пол в зале вымыт и стулья расставлены. Осталось только похвалить."
    mt "Семён, молодец…"
...
label dct_olga_p8:
    ...
    d_to "Ну поругалась. Так ведь по делу поругалась, какие претензии? Хорошо — молодая она еще. Я её где припугнул, где обманул, где убедил. А лет через десять она о таких как мы ноги вытирать будет."
    ...
    d_gd "Во-о-от."
    show d_bg normal suit with dspr
    d_gd "Значит, так и запишем: максимальный балл и еще сверх того; приказ на премию — заслужила; и запрет на работу у нас, бессрочный и на любой должности. В бухгалтерию я сама позвоню, а запрет — по вашей части."
    stop ambience
    ...
    th "Вот и всё. Завтрашний день ребятишки проведут без меня. Потом — пересменка, а дальше уже будет новая вожатая. Кто она, как она? Я ничего не знаю. Пусть мне и сказали, что это мой двойник, но верить обитателям поселка я теперь не могу."
    show sl sad pioneer close at left with dspr
    sl "Ольга Дмитриевна, вы сейчас уедете и не вернетесь."
    ...
    with easeoutleft
    th "Змея запускали."
    th "Что-то я смогла. В эту смену Электроник сам выловил своего тёзку, отвел в кружок и заставил сделать нормально летающий аппарат."
    ...
    th "Вот моя неудача. Не могу себе простить. Пусть Анатолий и уверяет меня, что всё в порядке. А я тогда еще надеялась здесь остаться и боялась давить на Анатолия. И теперь по лагерю ходит не Семён, а тень Семёна. Послушная, никогда не улыбающаяся, молчаливая тень."
    ...
    d_ss "Я вот тоже сдался. Но мы оба еще поднимемся. Я обещаю."
    stop ambience
    ...
    show d_sz normal pioneer at right:
        yalign 0.18
    with dspr
    th "Но никто не кричит: «Вожатка!», никто не дергается к выходу."
    hide d_sz
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_music_club_night
    dreamgirl "Это был не концерт, а разговор, беседа. Участвовали все, просто Мику, в отличие от остальных, не только разговаривала, а еще и играла, и пела. Но беседа закончилась, исчерпав себя, а Мику, после финальной песни, просто сказала."
    ...
    play ambience ambience_music_club_night
    show mi normal pioneer with dspr
    mi "Понимаете, Олечкадмитиевна, у меня день рождения будет только через два месяца, когда мы все уже давно разъедемся, а я так хотела увидеть на нем ребят, что пригласила их сейчас."
    ...
    hide sl with moveoutright
    play sound sfx_slavya_run
    dreamgirl "Славя вложила в руку вожатой маленький сверток, неловко чмокнула ту в щеку и убежала к себе в домик."
    $ renpy.pause (3)
    stop music fadeout 1
    stop ambience
    stop sound
...
label dct_olga_p9:
    ...
    show d_to normal casual at center with dspr
    d_to "Уважаемые отъезжающие, просьба приготовить документы для проверки. Чтобы мне побыстрее разобраться прошу документы подавать в раскрытом виде. Вам ехать, а мне еще под дождем в модуль бежать."
    hide d_to with dspr
    ...
    dreamgirl "Как дежурный по КПП бежит в караулку, пряча от дождя список пассажиров с разрешающей визой Анатолия. Голубой, с белыми ромашками, зонт совершенно по дурацки смотрелся в сочетании с военной формой, но дежурному было все равно."
    dreamgirl "Дежурному важно было донести документ сухим и подшить его в папку, записав дату и номер списка к себе в журнал. Чтобы потом, когда-нибудь, если возникнет такая необходимость, любой проверяющий мог убедиться, что в дежурство этого прапорщика ни одна копия или микс не покидали поселок через восточные ворота."
    ...
    th "Сосед, всё пытается завязать беседу. Луше бы детектив свой читал."
    ...
    show un shocked pioneer at center with pixellate:
        alpha 0.45
    th "Лена сейчас испуганно выглядывает из домика и вздрагивает от каждой попадающей на нее капли."
    hide un
    show mi normal pioneer at center with pixellate:
        alpha 0.45
    th "А ей в спину несется бесконечный монолог Мику о том, как та любит дождь, но конечно не такой холодный."
    hide mi
    ...
    hide sl
    th "Вот только завтра для них начнется просто новый цикл, с новой вожатой. Остается только утешать себя, что я сделала всё что могла, что завтрашняя, искусственная «Ольга Дмитриевна», сможет защитить их и чуть-чуть, но скрасит их жизнь."
    stop music fadeout 1
    stop ambience
    ...
    show mt smile pioneer at center with dspr:
        alpha 0.3
    mt "Когда маленькая девочка Оля проснется в автобусе перед воротами, пусть она не рассчитывает на особые отношения с вожатой."
    stop music fadeout 1
    stop ambience
    ...
    $ persistent.sprite_time = "day"
    play ambience sfx_bus_loop fadein 2
    dreamgirl "Водитель проснулся минут через пятнадцать. Поерзал на сиденье, включил передачу, и автобус опять покатил по шоссе, как ни в чем не бывало."
    
    scene dct_ext_road_day_city with dissolve
    $ prolog_time ()
    $ persistent.sprite_time = "day"
    dreamgirl "Еще через десять минут впереди замаячила промышленная окраина города. По одному начали просыпаться пассажиры."
    
    scene int_bus with dissolve
    $ prolog_time ()
    $ persistent.sprite_time = "day"
    th "Когда-нибудь маленькая девочка Оля проснется в автобусе."
    ...
    "С облегчением улыбается: вот и еще один день прошел без происшествий."
    "Достает из шкафа запертую шкатулку, в которой, среди барахла, хранится старый засаленный ежедневник."
    ...
    $ persistent.sprite_time = "night"
    $ set_mode_nvl ()
    "Сначала её лицо трогает слабая улыбка, а потом оно совершенно преображается и перед нами оказывается не вздорная и ленивая «вожатка», а веселая, заводная и добрая двадцатилетняя девушка, которая сама не далеко ушла от своих пионеров."
    "Потом двадцатилетняя девушка исчезает и опять возвращается двадцатипятилетняя Ольга Дмитриевна. Только добавилась россыпь морщинок у нее вокруг глаз, и улыбается она теперь понимающе, с сочувствием и чуть с иронией."
