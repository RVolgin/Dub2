...
label dct_olga_p1:
    ...
    show d_to normal casual:
        ypos 0.15
    "Листал бумаги незнакомец долго. А в конце выдал…"
    ...
    "Несмотря на плохое первое впечатление, посёлок Ольге скорее понравился. Пляж, стадион, лодочная станция, лес. Расслабленная атмосфера, шорты, футболки, короткие юбки и лёгкие платья, яркие цвета в одежде. И только изредка попадающиеся военные хранили верность своей форме."
...
label dct_olga_p2:
    ...
    d_to "А её отчёт автоматически окажется секретным: те, кто имеет допуск, ничего не поймут, а кто поймёт — те допуска не имеют."
    ...
    "Ольгу разбудил солнечный зайчик, неяркий, но настойчивый. Он щекотал лицо, пробиваясь между неплотно задёрнутыми занавесками, и совершенно не давал доспать."
    ...
    "Кажется, экзаменаторов (или допрашивающих) интересовало про Ольгу буквально всё: от успеваемости до хобби, от школьных влюблённостей до любимого времени года."
    ...
    "Ольга в ходе совещания из Ольги Дмитриевны уже стала Ольгой. Впрочем, она и не возражала."
    stop ambience
    ...
    show blink
    "Ольга вытянула ноги, прикрыла глаза и почти прислонилась к ребристой стене модуля, и так и замерла в положении неустойчивого равновесия, вцепившись в край лавки руками."
    th "Если я отклонюсь назад чуть сильнее, я испачкаю блузку о стену."
    play sound sfx_bed_squeak2
    "Кто-то сел рядом, на дальний край лавочки."
    ...
    play ambience dct_ambience_conf
    show adl_sh glasses normal at cright with moveinright
    "В кабинете Ольге действительно было сделано предложение, правда, «Шурик» в начале чуть было всё не испортил."
    ...
    th "А почему нет?"
    d_mt2 "Я… Я согласна."
    "И дальше события побежали по бюрократической колее."
    stop ambience
    ...
    show blink
    "Но даже в снах всё продолжался прожитый день."
    stop ambience
    ...
    "Офицер с повязкой на рукаве шёл чуть впереди, показывая дорогу. Ольга отставала на полшага, а ещё на два шага позади шёл солдатик с вещмешком, замыкая процессию."
    ...
    "Анатолий вынырнул как из ниоткуда."
    ...
    "Двери автобуса с шипением закрылись, и автобус, мазнув фарами по кирпичному забору и воротам, развернулся и понёс Ольгу сквозь южную ночь навстречу будущему."
    play ambience sfx_bus_interior_moving
    "Ольга поглядывала на вещмешок, стоящий на соседнем сидении, и вспоминала слова передавшего мешок офицера: «Это вам на случай, если что-то пойдёт не так.»"
    "А потом офицер зеркально скопировал действия Анатолия, оглянувшись на того, маячащего в воротах: «И если всё пойдёт совсем не так, то послезавтра в двадцать три ноль-ноль на остановке будет автобус»."
    th "Как? Что? Что значит — не так?"
    "Что-то он знал, невзрачный капитан с повязкой дежурного по части."
    "А у Ольги впервые мелькнуло ещё даже не подозрение, а предчувствие подозрения, что утром в приёмной ей рассказали не всю правду. Но мелькнуло и исчезло."
    stop music fadeout 1
    stop ambience
...
label dct_olga_p3:
    ...
    "Ольга проснулась, когда автобус начал разворачиваться на площадке перед воротами. Вот он чуть сдал назад, дёрнулся и заглох."
    $ renpy.sound.set_volume(1.5, delay=0, channel='sound2')
    play sound2 sfx_ikarus_open_doors
    "С шипением отошла в сторону дверь." 
    ...
    "Ольга обвела глазами пустой салон — никого. Правда, никого и не ожидалось. И водитель, похоже, уже успел куда-то уйти."
    ...
    "Ольга подтянула к себе чемодан, подтянула подаренный вещмешок, судя по весу, по округлому и твёрдому на ощупь содержимому, набитый консервными банками."
    th "Не могу на них злиться, не могу над ними смеяться. Как там брат писал, что тушёнка — самое дорогое, что есть у солдата."
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_entrance_day
    "Тяжёлый чемодан, тяжёлый вещмешок… Ольга, пока допыхтела до двери, прокляла всё."
    ...
    "Ольга поправила форму, проверила, как повязан галстук, ровно ли сидит панама."
    ...
    "Было семь часов пятьдесят минут первого утра двухнедельного цикла. Впрочем, Ольга про циклы ничего не знала — для неё это было воскресенье, первый день смены."
    ...
    "Ольгу от предстоящей встречи с аборигенами то бросало в дрожь, то, наоборот, охлаждало до бесчувствия."
    ...
    "К счастью, кто-то когда-то повесил на стене тетрадный листок, где был расписан алгоритм включения трансляции."
    queue sound [sfx_click_2 , sfx_click_1 , sfx_click_3 , dct_sfx_horn_rise_tape ]
    "И в восемь часов ноль четыре минуты сигнал «Подъём» разбудил обитателей узла номер пятнадцать, или, как они сами считали, пионерского лагеря «Совёнок»."
    ...
    $ renpy.pause (2)
    "Звонкий девичий голос прозвучал из-за спины:"
    voice "Привет, ты только что приехала?"
    scene ext_clubs_day with vpunch
    "Ольгу опять затрясло. Ольга медленно, стараясь не подать вида, спрятала связку с ключами в сумочку и так же медленно обернулась к спрашивающей."
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_center_day
    "Сорок минут спустя Ольга стояла на площади под обстрелом детских и уже почти не детских, всего-то на три года младше её, глаз и снова отчаянно тряслась."
    ...
    "Ольга оглядела подобие строя, кивнула Славе, подождала, когда последние из малышей займут свои места, и начала свою первую линейку — пожалуй, единственное хорошее, что удалось Ольге в этот и в следующий день."
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_center_day
    "Как вскоре выяснила Ольга, лагерь прекрасно функционировал и без неё. Пионеры… Вот с пионерами было сложнее."
    "Пионеры тоже прекрасно функционировали без Ольги, скорее Ольга им даже мешала. Как будто в лагере действовала какая-то тайная сила."
    "И пока Ольга, раздавая поручения, не противоречила этой силе, всё было хорошо. Но стоило, например, поручить Лене…"
    stop ambience
    ...
    "И вот тогда Ольге стало по-настоящему страшно."
    "Страшно от синхронного движения ложек, подносящих очередную порцию ко рту, от синхронного движения механически жующих челюстей, от остановившихся взглядов."
    "Надо было или идти в зал, или уходить. А Ольга, вдруг ослабев, стояла, прислонившись к дверному косяку, и переводила взгляд с пионера на пионера."
    show sl doll pioneer at center with dissolve
    "Вот пионеры покончили с первым, разом, одинаковыми движениями отодвинули тарелки и принялись за второе, запивая его чаем."
    play sound sfx_hell_crickets_2
    hide sl
    show mz doll pioneer at center
    with dissolve
    "Вот они пообедали, встали из-за столов и спокойно, без суеты и лишних движений, построились в очередь к мойке."
    stop music fadeout 1
    stop ambience
    ...
    "А пионеры, поставив в окно мойки грязную посуду, разворачивались и вереницей шли к выходу."
    ...
    "И вот головной пионер встретился взглядом с Ольгой."
    play sound dct_sfx_scare
    th "Вот и всё."
    show blink
    "Ольга начала медленно оседать на пол. А коллективный организм, состоящий из пионеров, вдруг сломался, рассыпавшись на автономные единицы."
    # визг
    $ renpy.pause (1)
    hide el
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_center_day
    "Расталкивая всех, к Ольге подбежала Славя, подхватила, не дав упасть."
    "С помощью мальчиков из старшего отряда помогла сесть на лавку, принесла стакан холодного компота."
    ...
    "Ольга так и просидела в шезлонге перед домиком до самого вечера."
    ...
    hide sl with dspr
    stop sound fadeout 1
    "Ольга грызла горькие сухари и с благодарностью думала о вчерашних военных."
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_center_day
    "Весь следующий день Ольга ходила, поминутно оглядываясь."
    scene ext_houses_day
    ...
    "Но не только в столовой, везде было страшно. Всё время казалось, что стоит отвести взгляд, как пионеры за её спиной превращаются в бездушные механизмы."
    stop ambience
    ...
    $ persistent.sprite_time = "night"
    play ambience ambience_camp_center_day
    "Лампочка над крыльцом светила безжалостно-ярко, освещая цветок ромашки. Осторожно, так, чтобы не помять стебель, зажатый между створками дверей."
    th "Я не хочу об этом думать!"
    th "Нет!"
    "Не хотела думать, запрещала себе, но не смогла не представить, как без пяти десять в помещение заходит Славя, выгоняет оттуда Сыроежкина…"
    stop ambience
...
label dct_olga_p4:
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_int_cabin_day
    "Вожатая проснулась задолго до горна и даже до звонка будильника. Несмотря на то, что поздно легла, спать совершенно не хотелось."
    ...
    "Ольга, откинув простыню, присела на кровати, спустив ноги. Потянулась через проход к чемодану на соседней кровати и не дотянулась — пришлось привстать."
    th "Полный чемодан платьев, а надеть нечего. И кто в этом виноват, Оля? Сама же и виновата!"
    ...
    mt "Вольно."
    play music music_list["timid_girl"]
    "Сегодня линейка началась легко и свободно."
    ...
    stop ambience
    "Ольга подхватила метлу, закрутила двумя руками, как пропеллер, вокруг центра тяжести, остановила вращение, перекинула за спиной из правой руки в левую, опять закрутила и пошла в атаку на пионеров, угрожая древковым оружием."
    ...
    "Ольга улыбнулась, вспомнив, как позавчера чуть не насильно вытащила Славю за ворота."
    stop ambience
    ...
    play ambience ambience_camp_center_day
    play music music_list["dance_of_fireflies"]
    "Ночью к северу от лагеря прокатилась гроза. Удушающая жара, прижимавшая «Совёнок» к земле последние четыре дня, отпустила, и жить стало очень даже приятно."
    ...
    hide d_oz
    with dspr
    "Лёгкий ветерок, тянувший с реки, продувал насквозь жидкую рощу, отделявшую береговую линию от площади, и приятно шевелил волосы и гладил лицо."
    show blink
    ...
    "Запал уже проходил, но его ещё хватило бы для взбучки гостям."
    stop music fadeout 1
    stop ambience
    ...
    show d_ss normal shirt at left
    with dspr
    "Вот только гости оказались крепче нервами и сильнее тёртыми жизнью, чем Ольгины пионеры, поэтому на них грозный вид вожатой не подействовал."
...
label dct_olga_p5:
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_center_day
    "Ольга шла по посёлку, невольно сравнивая его с лагерем."
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_center_day
    th "Полный коммунизм: за жильё не плачу, за свет не плачу, питание бесплатное, даже спецодежду можно на складе подобрать импортную, такую, что никто и никогда не поймёт, что это спецодежда, и тоже бесплатно."
    ...
    "И на бедную Ольгу посыпались биографии всех более-менее заметных обитателей посёлка."
    stop ambience
    ...
    d_ol "Я выслушаю твои пожелания, и мы внесём изменения, если понадобится. И, собственно, всё."
    ...
    play ambience ambience_clubs_inside_day
    play music music_list["i_want_to_play"]
    "Больше всего Ольге понравилось моделировать будущую личность своего будущего двойника."
    ...
    "В виварии Ольге не понравилось. Пахло зверинцем, было темно и тесно. Обеспокоенные обезьяны бегали в своих клетках, кричали, и лишь одна, похоже, что уже накачанная успокоительными, безучастно сидела в углу около поилки."
    ...
    "Ольга кивала, слушая путаный инструктаж Олеси. Потом, когда инструктаж кончился, а больше ничего не происходило, заскучала. И от скуки стала вслушиваться в трёп сидящих в курилке техников-лаборантов."
    stop ambience
...
label dct_olga_p6:
    ...
    play ambience ambience_camp_center_night
    play sound_loop dct_sfx_steps2
    "До площади всем было по пути. Техники продолжили свой разговор, но, как Ольга ни вслушивалась, больше ничего интересного не услышала — говорили о футболе, о рыбалке и о политике."
...
label dct_olga_p7:
    ...
    "Началась новая смена, новое знакомство со старыми знакомыми."
    #show mt normal panama pioneer with dspr
    mt "Здравствуйте, пионеры!"
    voices "Здрав…"
    stop music fadeout 3
    show blink
    "А дальше работали только рефлексы, а рассудок у Ольги Дмитриевны вновь включился лишь на финальной реплике."
    hide blink
    ...
    d_to "Абсолютно. Подкормим, проверим, подкорректируем и вернём вам лучше чем был."
    show d_to normal casual
    ...
    sl "Хорошо."
    hide sl with fade
    "Больше на эту тему Славя не говорила, а пионеры — те вообще к ужину почти забыли о Семёне."
    stop music fadeout 2
    "Ольге тоже хватало хлопот, и за пару дней беспокойство сменилось просто галочкой в памяти, что вот есть такой пионер по имени Семён, который подъедет чуть позже."
    stop ambience
    ...
    $ persistent.sprite_time = "night"
    play ambience ambience_int_cabin_night
    "Ольге Дмитриевне хватало и своих забот. И главной заботой было продолжающееся ощущение постороннего взгляда."
    stop ambience
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_clubs_inside_day
    "Сыроежкин и правда сидел и трогал приборы, а иногда вставал и трогал инструменты. Вид он при этом имел очень задумчивый."
    ...
    el "Я? Ну. Да."
    mt "Или ты учишь мальчиков делать воздушных змеев. Или{w=2}… Или ты прямо сейчас пойдёшь и скажешь Жене, что она тебе очень нравится."
...
label dct_olga_p8:
    ...
    hide sl with dspr
    "Девушки подобрали мяч на баскетбольной площадке, забытый кем-то из пионеров, забросили, каждая по разу, его в корзину."
    ...
    $ persistent.sprite_time = "night"
    play ambience ambience_camp_center_night
    "С Мику действительно получилось хорошо…"
    "Вчера, уже после отбоя, Ольга Дмитриевна обходила лагерь."
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_music_club_night
    "Это был не концерт, а разговор, беседа. Участвовали все, просто Мику, в отличие от остальных, не только разговаривала, а ещё и играла и пела. Но беседа закончилась, исчерпав себя, а Мику после финальной песни просто сказала:"
    ...
    play ambience ambience_music_club_night
    show mi normal pioneer with dspr
    mi "Понимаете, Олечкадмитриевна, у меня день рождения будет только через два месяца, когда мы все уже давно разъедемся, а я так хотела увидеть на нём ребят, что пригласила их сейчас."
    ...
    hide sl with moveoutright
    play sound sfx_slavya_run
    "Славя вложила в руку вожатой маленький свёрток, неловко чмокнула ту в щеку и убежала к себе в домик."
    $ renpy.pause (3)
    stop music fadeout 1
    stop ambience
    stop sound
...
label dct_olga_p9:
    ...
    hide d_to with dspr
    "Заскрипели ворота. Оле было видно, как их закрывают двое солдат. Как водитель автобуса, не обращая внимания на погоду, торопливо курит, выскочив на улицу."
    "Как дежурный по КПП бежит в караулку, пряча от дождя список пассажиров с разрешающей визой Анатолия. Голубой с белыми ромашками зонт совершенно по-дурацки смотрелся в сочетании с военной формой, но дежурному было всё равно."
    "Дежурному важно было донести документ сухим и подшить его в папку, записав дату и номер списка к себе в журнал. Чтобы потом, когда-нибудь, если возникнет такая необходимость, любой проверяющий мог убедиться, что в дежурство этого прапорщика ни одна копия или микс не покидали посёлок через восточные ворота."
    "Разумеется, никого, кроме оригиналов, в этой вакуоли и не было, но порядок есть порядок."
    stop ambience
    ...
    "Ольга не хотела думать о пионерах, но не получалось."
    ...
    "В окне последний раз мелькнули ворота."
    "Асфальт сменился бетонкой, автобус наконец смог разогнаться и сейчас, чуть вздрагивая на стыках плит, катился по степи, подбираясь к границам вакуоли."
    "Как обычно, при приближении к зоне перехода начало темнеть, а пассажиров автобуса потянуло в сон. Человеческое сознание протестовало таким образом против невозможных, с его точки зрения, вещей."
    show blink
    "Пять, десять, пятнадцать минут, и в автобусе не осталось ни одного бодрствующего человека."
    "Уснул и надоедливый сосед, уснула и Ольга. Последним уснул водитель в своей экранированной кабине."
    stop ambience fadeout 1
    "Повинуясь автоматике, автобус плавно затормозил и остановился, тихо ворча двигателем, работающим на холостом ходу."
    ...
    $ persistent.sprite_time = "day"
    play ambience sfx_bus_loop fadein 2
    "Водитель проснулся минут через пятнадцать. Поёрзал на сиденье, включил передачу, и автобус опять покатил по шоссе как ни в чём не бывало."
    
    scene dct_ext_road_day_city with dissolve
    $ prolog_time ()
    $ persistent.sprite_time = "day"
    "Ещё через десять минут впереди замаячила промышленная окраина города. По одному начали просыпаться пассажиры."
    ...
    $ persistent.sprite_time = "night"
    $ set_mode_nvl ()
    "Сначала её лицо трогает слабая улыбка, а потом оно совершенно преображается, и перед нами оказывается не вздорная и ленивая «вожатка», а весёлая, заводная и добрая двадцатилетняя девушка, которая сама недалеко ушла от своих пионеров."
...
menu:
        ...
        "Продолжить с динамичной подачей (темп сюжета как в предыдущих частях)":
            $ dct_dynped = True
            jump dct_coin_dyn
        "Продолжить с педантичной подачей (оригинальное литературное повествование)":
            $ dct_dynped = False
            jump dct_coin_ped
        "В меню":
            jump dct_mnu2   
