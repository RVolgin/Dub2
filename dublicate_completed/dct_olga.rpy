...
label dct_olga_p2:
    ...
    "А потом офицер зеркально скопировал действия Анатолия, оглянувшись на того, маячащего в воротах: «И если всё пойдет совсем не так, то послезавтра в двадцать три ноль-ноль на остановке будет автобус»."
...
label dct_olga_p3:
    ...
    "И в восемь часов ноль четыре минуты сигнал «Подъём» разбудил обитателей узла номер двадцать два, или, как они сами считали, пионерского лагеря «Совёнок»."
...
label dct_olga_p9:
    ...
    "Повинуясь автоматике, автобус плавно затормозил и остановился, тихо ворча двигателем, работающем на холостом ходу."
