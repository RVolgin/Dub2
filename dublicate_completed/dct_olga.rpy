...
label dct_olga_p5:
    ...
    show d_ol normal pen1 far at right with dissolve #Олеся, спрайт заглушка из "По ту сторону Совёнка"
...
label dct_olga_p6:
    ...
    show d_ol normal pen2 close with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    d_ol "Знала бы ты, какое старье пользуем."
    show d_ol shy pen2 close with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    extend " Шеф такой умница, а ему финансирование все режут и режут. Как он результатов добивается — ума не приложу."
    show d_ol normal pen2 close with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
