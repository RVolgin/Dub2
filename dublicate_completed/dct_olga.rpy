...
label dct_olga_p2:
    ...
    "Но и она узнала не мало, о том странном месте, куда привёз её автобус."
    "Помалкивали двое: пожилая, на грани старости, женщина очень властного вида, кажется, исполняющая обязанности здешнего директора, и мужчина с копной каштановых волос, и такой же бородой, больше всего похожий на геолога из старого, ещё черно-белого фильма."
    ...
    play ambience ambience_int_cabin_night
    d_mt2 "Да?"
    th "Половина четвертого. Кого ещё несёт?"
    ...
    dreamgirl "А потом офицер зеркально скопировал действия Анатолия, оглянувшись на того, маячущего в воротах: «И если всё пойдет совсем не так, то послезавтра, в двадцать три ноль-ноль, на остановке будет автобус»."
...
label dct_olga_p4:
    ...
    th "Видимо, придётся сочинять. А еще придётся учитывать «особенности» каждого пионера, чтобы не было таких проколов, как с Леной."
...
label dct_olga_p5:
    ...
    d_gd "Во-первых, не склонного, а, во-вторых, не начнёт. Я, Александр, знаю причину и повод, а вы нет. Если у вас всё по этой теме, то давайте перейдем к делам Вашей лаборатории."
    stop music fadeout 1
    stop ambience
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_int_cabin_day
    th "До обеда еще масса времени. Комнату убрала ещё до завтрака, в бухгалтерии побывала, что там у меня дальше?"
    ...
    show d_ol normal pen2 at left with dissolve:  #Олеся, спрайт заглушка из "По ту сторону Совёнка"
        xzoom -1.0
    d_ol "Ты, главное, за ворота не выглядывай, а то развернешь Систему на себя. А как я тебе скомандую, сразу бери веревку и тащи за неё тележку с клеткой сюда. А приборы техники утром заберут."
...
label dct_olga_p6:
    ...
    show d_ol normal pen2 close with dspr #Олеся, спрайт заглушка из "По ту сторону Совёнка"
    d_ol "А ты вообще, хотела сама пойти, вместо обезьянки. Не бойся, всё идёт, как надо, я в первый раз тоже дергалась."
...
label dct_olga_p7:
    ...
    show d_sm scared pioneer with dspr
    me "А вместо этого остались ещё на смену! И все, все уверяют меня, что мы только сюда приехали! Даже Славя, ведет себя так, будто только познакомилась со мной! Скажите мне, что это сон, пожалуйста!"
...
label dct_olga_p9:
    ...
    show d_to normal casual at center with dspr
    d_to "Уважаемые отъезжающие, просьба приготовить документы для проверки. Чтобы мне побыстрее разобраться, прошу документы подавать в раскрытом виде. Вам ехать, а мне ещё под дождем в модуль бежать."
    hide d_to with dspr
