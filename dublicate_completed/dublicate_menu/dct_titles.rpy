init 1:
    ...
    # $ style.dct_hyperlink.underline = False
    ...
    $ dct_Moments = "mods/dublicate/sounds/coin/music/Moments_(by_Shane_Ivers).ogg"
    ...
    screen dct_titles_sovenok:
        ...
        text 'Посвящается памяти Тангейзера Вагнерова.\n\n{vspace=15}От тех, кому не всё равно. Для тех, кто ждал и верил.\n\n{vspace=15}...Где-то в мире бесконечного лета в лагерь приехал новенький: высокий, сутулый и худой,\nпо характеру и любви к книгам и технике — что-то среднее между Электроником и Женей.\nСкоро он проснётся, через положенное время выйдет из автобуса и пойдёт к воротам Совёнка\nнавстречу Славе.\n\n{vspace=15}А подброшенная вверх монетка навсегда останется стоять на ребре.':
            xpos 0.115
            yalign 0.9
            #text_align 0.5
            color "#fff"
...
label dct_credits:
    ...
    show dct_ext_train_day_not_train
    show image(Solid("#000000")):
        alpha 1
        linear 2 alpha 0.15
    $ renpy.pause(2,hard=True)
