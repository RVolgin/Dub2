init :
    ...
    # image dct_ext_bus_sunrise = "mods/dublicate/images/bg/dct_ext_bus_sunrise.jpg"    # Остановка с Икарусом, утро
    # image dct_int_bus_sunrise = "mods/dublicate/images/bg/dct_int_bus_sunrise.jpg"    # Внутри Икаруса, утро
    ...
    $ Everlasting_Summer_electric_guitar_cover = "mods/dublicate/sounds/coin/music/Everlasting_Summer_Main_Theme_[electric_guitar_cover](youtu.be_hVT9O5yVYU4).ogg"
