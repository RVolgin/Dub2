init :
    ...
    image dct_int_house_of_mi_day = "mods/dublicate/images/bg/dct_int_house_of_mi_day.jpg"        # Домик Жени и Мику
    image dct_int_house_of_mi_night = "mods/dublicate/images/bg/dct_int_house_of_mi_night.jpg"      # ———//———
    image dct_int_house_of_mi_sunset = "mods/dublicate/images/bg/dct_int_house_of_mi_sunset.jpg"    # ———//———
    image dct_int_house_of_sa_day = "mods/dublicate/images/bg/dct_int_house_of_sa_day.jpg"        # Домик Лены и Саши
    image dct_int_house_of_sa_night = "mods/dublicate/images/bg/dct_int_house_of_sa_night.jpg"      # ———//———
    image dct_int_house_of_sa_sunset = "mods/dublicate/images/bg/dct_int_house_of_sa_sunset.jpg"    # ———//———
    image dct_int_house_of_sl_night = "mods/dublicate/images/bg/dct_int_house_of_sl_night.jpg"      # Домик Жени и Слави
    image dct_int_house_of_sl_sunset = "mods/dublicate/images/bg/dct_int_house_of_sl_sunset.jpg"    # ———//———
    image dct_int_house_of_un_sunset = "mods/dublicate/images/bg/dct_int_house_of_un_sunset.jpg"    # Домик Лены и Мику
    ...
    image dct_dv_broom_on_square = "mods/dublicate/images/cg/dct_dv_broom_on_square.jpg" # Алиса с метлой на площади
    image dct_dv_cry_behind_bathhouse = "mods/dublicate/images/cg/dct_dv_cry_behind_bathhouse.jpg" # Алиса плачет за баней
    ...
    image dct_names_in_clouds_island_dv_me_us = "mods/dublicate/images/cg/dct_names_in_clouds_island_dv_me_us.png"    # Семён на острове рассказывает сказку Алисе и Ульяне (Имена в облаках)
    ...
    image dct_us_old_camp_with_binoculars = "mods/dublicate/images/cg/dct_us_old_camp_with_binoculars.jpg"
    ...
    $ mirabilis_futurum = "mods/dublicate/sounds/music/mirabilis_futurum.ogg"
    ...
    $ dct_sfx_5500Hz = "mods/dublicate/sounds/sfx/dct_sfx_5500Hz.ogg"                                                       # писк
    $ dct_sfx_UAZ_engine = "mods/dublicate/sounds/sfx/dct_sfx_UAZ_engine.ogg"                                               # Заведённый УАЗ во сне Шурика
    $ dct_sfx_alarm = "mods/dublicate/sounds/sfx/dct_sfx_alarm.ogg"                                                         # звенит будильник
    ...
    $ dct_sfx_apple = "mods/dublicate/sounds/sfx/dct_sfx_apple.ogg"                                                         # хруст веток и глухие звуки падения чего-то на землю
    $ dct_sfx_badger = "mods/dublicate/sounds/sfx/dct_sfx_badger.ogg"                                                       # барсук недоволен
    $ dct_sfx_badminton = "mods/dublicate/sounds/sfx/dct_sfx_badminton.ogg"                                                 # сильные удары ракеткой по воланчику
    $ dct_sfx_breaking_glass = "mods/dublicate/sounds/sfx/dct_sfx_breaking_glass.ogg"                                       # громко бьющееся стекло
    $ dct_sfx_broom = "mods/dublicate/sounds/sfx/dct_sfx_broom.ogg"                                                         # неторопливое шарканье метлой
    $ dct_sfx_bus_arrival = "mods/dublicate/sounds/sfx/dct_sfx_bus_arrival.ogg"                                             # прибытие автобуса, с улицы
    $ dct_sfx_bus_braking = "<from 8.1 to 12.5>mods/dublicate/sounds/sfx/dct_sfx_bus_arrival.ogg"                           # притормаживание автобуса, с улицы
    $ dct_sfx_bus_departure = "mods/dublicate/sounds/sfx/dct_sfx_bus_departure.ogg"                                         # отбытие автобуса, с улицы
    $ dct_sfx_bus_departure2 = "mods/dublicate/sounds/sfx/dct_sfx_bus_departure2.ogg"                                       # отбытие автобуса кратко, с улицы
    $ dct_sfx_bus_door = "mods/dublicate/sounds/sfx/dct_sfx_bus_door.ogg"                                                   # открывается дверь автобуса в тишине
    $ dct_sfx_chair = "mods/dublicate/sounds/sfx/dct_sfx_chair.ogg"                                                         # двигающийся стул
    $ dct_sfx_clang = "mods/dublicate/sounds/sfx/dct_sfx_clang.ogg"                                                         # лязг челюстей кошкоробота (упавшая на пол железяка)
    $ dct_sfx_close_door_hard = "mods/dublicate/sounds/sfx/dct_sfx_close_door_hard.ogg"                                     # хлопок дверью с дребезгом
    ...
    $ dct_sfx_cry_short = "mods/dublicate/sounds/sfx/dct_sfx_cry_short.ogg"                                                 # два всхлипа
    $ dct_sfx_dart ="mods/dublicate/sounds/sfx/dct_sfx_dart.ogg"                                                            # стрела попадает в цель
    $ dct_sfx_discharge = "mods/dublicate/sounds/sfx/dct_sfx_discharge.ogg"                                                 # гром и разряд
    $ dct_sfx_facepalm = "mods/dublicate/sounds/sfx/dct_sfx_facepalm.ogg"                                                   # хлопок, удар по лбу
    $ dct_sfx_fall = "mods/dublicate/sounds/sfx/dct_sfx_fall.ogg"                                                           # прыжок на землю
    $ dct_sfx_fallen_book = "mods/dublicate/sounds/sfx/dct_sfx_fallen_book.ogg"                                             # падение книги на пол
    $ dct_sfx_femscreech = "mods/dublicate/sounds/sfx/dct_sfx_femscreech.ogg"                                               # женский визг в ужасе
    $ dct_sfx_forest_day2 = "mods/dublicate/sounds/sfx/dct_sfx_forest_day2.ogg"                                             # жужжание насекомых, сверчки, птички
    $ dct_sfx_fright = "mods/dublicate/sounds/sfx/dct_sfx_fright.ogg"                                                       # ах!
    $ dct_sfx_grass_steps = "mods/dublicate/sounds/sfx/dct_sfx_grass_steps.ogg"                                             # шаги по траве или земле, 2 человека
    ...
    $ dct_sfx_horn_rebound_through_loudspeaker = "mods/dublicate/sounds/sfx/dct_sfx_horn_rebound_through_loudspeaker.ogg"   # Горн-отбой через репродуктор
    ...
    $ dct_sfx_horn_rise_through_loudspeaker = "mods/dublicate/sounds/sfx/dct_sfx_horn_rise_through_loudspeaker.ogg"         # Горн-подъём через репродуктор
    $ dct_sfx_inhale = "mods/dublicate/sounds/sfx/dct_sfx_inhale.ogg"                                                       # глубокий вздох
    $ dct_sfx_jump = "mods/dublicate/sounds/sfx/dct_sfx_jump.ogg"                                                           # прыг из автобуса
    $ dct_sfx_jump_in_swamp = "mods/dublicate/sounds/sfx/dct_sfx_jump_in_swamp.ogg"                                         # прыжок в грязь
    $ dct_sfx_knife_drop = "mods/dublicate/sounds/sfx/dct_sfx_knife_drop.ogg"                                               # упавший со звоном нож
    $ dct_sfx_lift = "mods/dublicate/sounds/sfx/dct_sfx_lift.ogg"                                                           # звуки лифта
    $ dct_sfx_loop_bus_moves_slow = "<from 18.27 to 51.79>mods/dublicate/sounds/sfx/dct_sfx_bus_moves_between_stops.ogg"    # автобус едет и останавливается, из салона
    $ dct_sfx_match = "mods/dublicate/sounds/sfx/dct_sfx_match.ogg"                                                         # разгорается спичка
    $ dct_sfx_monitor = "mods/dublicate/sounds/sfx/dct_sfx_monitor.ogg"                                                     # кардиомонитор
    $ dct_sfx_monkey_cry = "mods/dublicate/sounds/sfx/dct_sfx_monkey_cry.ogg"                                               # обезьяне больно
    $ dct_sfx_open_metall_door = "mods/dublicate/sounds/sfx/dct_sfx_open_metall_door.ogg"                                   # открывается железная дверь со скрипом
    $ dct_sfx_pages = "mods/dublicate/sounds/sfx/dct_sfx_pages.ogg"                                                         # шелест страниц
    $ dct_sfx_phone_disk = "mods/dublicate/sounds/sfx/dct_sfx_phone_disk.ogg"                                               # набор номера на диске
    $ dct_sfx_ping_pong = "mods/dublicate/sounds/sfx/dct_sfx_ping_pong.ogg"                                                 # шарик упал на пол и прыгает
    $ dct_sfx_pulse = "mods/dublicate/sounds/sfx/dct_sfx_pulse.ogg"                                                         # быстро бьётся сердце
    $ dct_sfx_pulse_slow = "mods/dublicate/sounds/sfx/dct_sfx_pulse_slow.ogg"                                               # медленно бьётся сердце
    ...
    $ dct_sfx_robot_run_away = "mods/dublicate/sounds/sfx/dct_sfx_robot_run_away.ogg"                                       # быстрый топот кошкоробота
    ...
    $ dct_sfx_running = "mods/dublicate/sounds/sfx/dct_sfx_running.ogg"                                                     # кто-то пробегает мимо
    $ dct_sfx_rustle_alice = "mods/dublicate/sounds/sfx/dct_sfx_rustle_alice.ogg"                                           # шуршание и возня
    $ dct_sfx_scare = "mods/dublicate/sounds/sfx/dct_sfx_scare.ogg"                                                         # испуганное ах!
    $ dct_sfx_scissors = "mods/dublicate/sounds/sfx/dct_sfx_scissors.ogg"                                                   # ножницы, стрижка волос
    $ dct_sfx_short_beeps = "mods/dublicate/sounds/sfx/dct_sfx_short_beeps.ogg"                                             # короткие гудки в телефоне
    $ dct_sfx_sht40_1 = "mods/dublicate/sounds/sfx/dct_sfx_sht40_1.ogg"                                                     # выстрел сигнальной ракетой
    $ dct_sfx_sht40_2 = "mods/dublicate/sounds/sfx/dct_sfx_sht40_2.ogg"                                                     # звуковой сигнал ракеты СХТ
    $ dct_sfx_slammed_book = "mods/dublicate/sounds/sfx/dct_sfx_slammed_book.ogg"                                           # брошенная на стол книга
    $ dct_sfx_soldiers_run_continue = "mods/dublicate/sounds/sfx/dct_sfx_soldiers_run_continue.ogg"                         # строевой шаг
    $ dct_sfx_soldiers_run_start = "mods/dublicate/sounds/sfx/dct_sfx_soldiers_run_start.ogg"                               # строевой шаг, приближается
    $ dct_sfx_soldiers_run_stop = "mods/dublicate/sounds/sfx/dct_sfx_soldiers_run_stop.ogg"                                 # строевой шаг, удаляется
    $ dct_sfx_solo_card = "mods/dublicate/sounds/sfx/dct_sfx_solo_card.ogg"                                                 # одиночная брошенная карта
    $ dct_sfx_splash_in_swamp = "mods/dublicate/sounds/sfx/dct_sfx_splash_in_swamp.ogg"                                     # два падения или шага в болото с бульканием
    $ dct_sfx_steps2 = "mods/dublicate/sounds/sfx/dct_sfx_steps2.ogg"                                                       # шаги нескольких человек по твердому полу
    $ dct_sfx_steps3 = "mods/dublicate/sounds/sfx/dct_sfx_steps3.ogg"                                                       # один человек идет по траве
    $ dct_sfx_steps_in_swamp = "mods/dublicate/sounds/sfx/dct_sfx_steps_in_swamp.ogg"                                       # быстрые шаги по грязи или луже
    ...
    $ dct_sfx_teapot = "mods/dublicate/sounds/sfx/dct_sfx_teapot.ogg"                                                       # чайник звенит крышкой
    $ dct_sfx_teapot1 = "mods/dublicate/sounds/sfx/dct_sfx_teapot1.ogg"                                                     # чайник кипит и начинает свистеть
    $ dct_sfx_teaspoon = "mods/dublicate/sounds/sfx/dct_sfx_teaspoon.ogg"                                                   # чайная ложка в кружке
    $ dct_sfx_train_arrival = "mods/dublicate/sounds/sfx/dct_sfx_train_arrival.ogg"                                         # прибытие поезда
    $ dct_sfx_train_arrival_with_horn = "mods/dublicate/sounds/sfx/dct_sfx_train_arrival_with_horn.ogg"                     # приближающийся поезд гудит и останавливается
    $ dct_sfx_train_arrival_with_horn_far = "mods/dublicate/sounds/sfx/dct_sfx_train_arrival_with_horn_far.ogg"             # поезд гудит издалека и останавливается
    $ dct_sfx_train_horn_far = "mods/dublicate/sounds/sfx/dct_sfx_train_horn_far.ogg"                                       # приближающийся поезд гудит
    ...
    $ dct_sfx_voices_in_forest = "mods/dublicate/sounds/sfx/dct_sfx_voices_in_forest.ogg"                                   # голоса людей на фоне птичек
    $ dct_sfx_well1 = "mods/dublicate/sounds/sfx/dct_sfx_well1.ogg"                                                         # колодец, ведро опускается
    $ dct_sfx_well2 = "mods/dublicate/sounds/sfx/dct_sfx_well2.ogg"                                                         # колодец, ведро поднимается
    $ dct_sfx_well3 = "mods/dublicate/sounds/sfx/dct_sfx_well3.ogg"                                                         # колодец, ведро плещется и звенит ручкой
    $ dct_sfx_whistle = "mods/dublicate/sounds/sfx/dct_sfx_whistle.ogg"                                                     # свисток судьи
    $ dct_sfx_wood_floor_squeak = "mods/dublicate/sounds/sfx/dct_sfx_wood_floor_squeak.ogg"                                 # скрип досок пола 
    $ dct_us_laugh = "mods/dublicate/sounds/sfx/dct_us_laugh.ogg"                                                           # громкий смех
    #Стук в дверь разной агрессивности
    $ dct_sfx_knock_door1 = "mods/dublicate/sounds/sfx/dct_sfx_knock_door1.ogg"                                             # тук-тук-тук
    $ dct_sfx_knock_door2 = "mods/dublicate/sounds/sfx/dct_sfx_knock_door2.ogg"                                             # громкий быстрый стук
    $ dct_sfx_knock_door3 = "mods/dublicate/sounds/sfx/dct_sfx_knock_door3.ogg"                                             # настойчивый стук
    #Кошка
