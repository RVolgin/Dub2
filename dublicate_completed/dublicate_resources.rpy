init :
    ...
    image dct_clubs_male_comp_day = "mods/dublicate_completed/images/bg/coin/dct_clubs_male_comp_day.jpg"     # Рабочий стол с компом в клубе кибертнетиков
    image dct_clubs_male_comp_night = "mods/dublicate_completed/images/bg/coin/dct_clubs_male_comp_night.jpg"
    image dct_clubs_male_comp_night_light_mon = "mods/dublicate_completed/images/bg/coin/dct_clubs_male_comp_night_light_mon.jpg"
    image dct_clubs_male_comp_sunset = "mods/dublicate_completed/images/bg/coin/dct_clubs_male_comp_sunset.jpg"
    image dct_ext_clubs_night_light_inside = "mods/dublicate_completed/images/bg/coin/dct_ext_clubs_night_light_inside.jpg" # Здание клуба кибернетиков ночью со светящимися окнами
    image dct_ext_buses_filled = "mods/dublicate_completed/images/bg/coin/dct_ext_buses_filled.jpg"       # Икарус и ЛАЗ на стоянке, в Икарусе сидят люди
    image dct_ext_house_of_el_day = "mods/dublicate_completed/images/bg/coin/dct_ext_house_of_el_day.jpg"     # Домик кибернетиков ЭКСТЕРЬЕР
    image dct_ext_house_of_el_night = "mods/dublicate_completed/images/bg/coin/dct_ext_house_of_el_night.jpg"
    image dct_ext_house_of_el_sunset = "mods/dublicate_completed/images/bg/coin/dct_ext_house_of_el_sunset.jpg"
    image dct_ext_library_sunset = "mods/dublicate_completed/images/bg/coin/dct_ext_library_sunset.jpg"
    image dct_int_bus_middle = "mods/dublicate_completed/images/bg/coin/dct_int_bus_middle.jpg"   # Салон автобуса, левый борт
    image dct_int_bus_another_middle = "mods/dublicate_completed/images/bg/coin/dct_int_bus_another_middle.jpg"   # Салон автобуса, правый борт
    image dct_int_bus_people = "mods/dublicate_completed/images/bg/coin/dct_int_bus_people.jpg"   # Салон автобуса, видоизменённая передняя площадка
    image dct_int_bus_stern = "mods/dublicate_completed/images/bg/coin/dct_int_bus_stern.jpg"     # Салон автобуса, задняя площадка
    image dct_ext_camp_entrance_night = "mods/dublicate_completed/images/bg/coin/dct_ext_camp_entrance_night.jpg" # Вид на клуб и на ворота лагеря ночью
    image dct_int_clubs_male_night = "mods/dublicate_completed/images/bg/coin/dct_int_clubs_male_night.jpg"   # Внутри клуба ночью
    image dct_int_clubs_male_night_light = "mods/dublicate_completed/images/bg/coin/dct_int_clubs_male_night_light.jpg"
    image dct_int_clubs_male_night_light_mon = "mods/dublicate_completed/images/bg/coin/dct_int_clubs_male_night_light_mon.jpg"
    image dct_int_house_of_el_day = "mods/dublicate_completed/images/bg/coin/dct_int_house_of_el_day.jpg"     # Домик кибернетиков ИНТЕРЬЕР
    image dct_int_house_of_el_night = "mods/dublicate_completed/images/bg/coin/dct_int_house_of_el_night.jpg"
    image dct_int_house_of_el_night_light = "mods/dublicate_completed/images/bg/coin/dct_int_house_of_el_night_light.jpg"
    image dct_int_house_of_el_sunset = "mods/dublicate_completed/images/bg/coin/dct_int_house_of_el_sunset.jpg"
    
    
    
    image dct_dream_sh_first_disert = "mods/dublicate_completed/images/bg/coin/dct_dream_sh_first_disert.jpg"
    image dct_int_library_standing_desk_back = "mods/dublicate_completed/images/bg/coin/dct_int_library_standing_desk_back.jpg"   # Бибилотека, вид из-за Жениного стола
    image dct_int_library_standing_desk_front = "mods/dublicate_completed/images/bg/coin/dct_int_library_standing_desk_front.png"
    image dct_ext_musclub_backside_night = "mods/dublicate_completed/images/bg/coin/dct_ext_musclub_backside_night.jpg"   # Музыкальный клуб с тыльной стороны ночью
    image dct_ext_musclub_backside_night_brightwindows = "mods/dublicate_completed/images/bg/coin/dct_ext_musclub_backside_night_brightwindows.jpg"   # Музыкальный клуб с тыльной стороны ночью со светящимися окнами
    image dct_ext_dining_bench_day = "mods/dublicate_completed/images/bg/coin/dct_ext_dining_bench_day.png"       # Скамейка у входа в столовую, ДЕНЬ
    image dct_ext_dining_bench_day_front = "mods/dublicate_completed/images/bg/coin/dct_ext_dining_bench_day_front.png"   # Скамейка у входа в столовую (только скамейка, столб и угол здания)
    image dct_ext_dining_bench_sunset = "mods/dublicate_completed/images/bg/coin/dct_ext_dining_bench_sunset.png" # Скамейка у входа в столовую, ЗАКАТ
    image dct_ext_dining_door_day = "mods/dublicate_completed/images/bg/coin/dct_ext_dining_door_day.jpg"         # Двери столовой, ДЕНЬ
    image dct_ext_dining_door_day_front = "mods/dublicate_completed/images/bg/coin/dct_ext_dining_door_day_front.png" # Двери столовой (только лавка и ограждение)
    image dct_ext_dining_door_sunset = "mods/dublicate_completed/images/bg/coin/dct_ext_dining_door_sunset.jpg"   # Двери столовой, ЗАКАТ
    image dct_int_dining_hall_table_day_back = "mods/dublicate_completed/images/bg/coin/dct_int_dining_hall_table_day_back.jpg"   # Обеденный стол, ДЕНЬ
    image dct_int_dining_hall_table_day_back_people = "mods/dublicate_completed/images/bg/coin/dct_int_dining_hall_table_day_back_people.jpg"
    image dct_int_dining_hall_table_day_chairs = "mods/dublicate_completed/images/bg/coin/dct_int_dining_hall_table_day_chairs.png"
    image dct_int_dining_hall_table_day_front = "mods/dublicate_completed/images/bg/coin/dct_int_dining_hall_table_day_front.png"
    image dct_int_dining_hall_table_sunset_back = "mods/dublicate_completed/images/bg/coin/dct_int_dining_hall_table_sunset_back.jpg" # Обеденный стол, ЗАКАТ
    image dct_int_dining_hall_table_sunset_back_people = "mods/dublicate_completed/images/bg/coin/dct_int_dining_hall_table_sunset_back_people.jpg"
    image dct_int_dining_hall_table_sunset_chairs = "mods/dublicate_completed/images/bg/coin/dct_int_dining_hall_table_sunset_chairs.png"
    image dct_int_dining_hall_table_sunset_front = "mods/dublicate_completed/images/bg/coin/dct_int_dining_hall_table_sunset_front.png"
    image dct_ext_сentral_alley_from_dining_hall_to_west = "mods/dublicate_completed/images/bg/coin/dct_ext_сentral_alley_from_dining_hall_to_west.jpg" # Главная аллея лагеря от столовой с видом на западные ворота
    image dct_ext_playground_opposite_gate_day = "mods/dublicate_completed/images/bg/coin/dct_ext_playground_opposite_gate_day.jpg"
    image dct_int_dining_hall_people_sunset = "mods/dublicate_completed/images/bg/coin/dct_int_dining_hall_people_sunset.jpg"
    image dct_ext_music_club_sunset = "mods/dublicate_completed/images/bg/coin/dct_ext_music_club_sunset.jpg"
    ...
    image dct_ext_glade_behind_clubs_day = "mods/dublicate_completed/images/bg/coin/dct_ext_glade_behind_clubs_day.jpg"   # Полянка за зданием кружка кибернетики, ДЕНЬ
    image dct_ext_glade_behind_clubs_night = "mods/dublicate_completed/images/bg/coin/dct_ext_glade_behind_clubs_night.jpg"   # Полянка за зданием кружка кибернетики, НОЧЬ
    image dct_ext_glade_behind_clubs_sunset = "mods/dublicate_completed/images/bg/coin/dct_ext_glade_behind_clubs_sunset.jpg"   # Полянка за зданием кружка кибернетики, ЗАКАТ
    ...
    image dct_ext_square_profile_view_day = "mods/dublicate_completed/images/bg/coin/dct_ext_square_profile_view_day.jpg" # Площадь с боку днём, вид на Генду и админ. корпус
    image dct_ext_alley_from_library_to_square = "mods/dublicate_completed/images/bg/coin/dct_ext_alley_from_library_to_square.jpg" # Аллея от бибилиотеки к площади
    image dct_int_clubs_male2_night_zoom = "mods/dublicate_completed/images/bg/coin/dct_int_clubs_male2_night_zoom.jpg" # Кладовка кибернетиков (левая половина) в двукратном зуме
    image dct_ext_beach_barhan = "mods/dublicate_completed/images/bg/coin/dct_ext_beach_barhan.jpg" # Пляж с тентом-зонтиком днём
    image dct_ext_beach_day_lifesaving_shield = "mods/dublicate_completed/images/bg/coin/dct_ext_beach_day_lifesaving_shield.jpg" # Пляж со щитом средств для спасения утопающих
    
    
    
    image dct_ext_forest_dark_night = "mods/dublicate_completed/images/bg/coin/dct_ext_forest_dark_night.jpg" # "Дремучий лес" (Шурик пробирается по лагерю)
    image dct_int_musclub_night_light = "mods/dublicate_completed/images/bg/coin/dct_int_musclub_night_light.jpg" # Музклуб внутри (ночь, свет включён)
    image dct_int_musclub_night_nolight = "mods/dublicate_completed/images/bg/coin/dct_int_musclub_night_nolight.jpg" # Музклуб внутри (ночь, свет выключён)
    image dct_ext_music_club_verandah_night = "mods/dublicate_completed/images/bg/coin/dct_ext_music_club_verandah_night.jpg" # Музклуб, веранда (ночь, свет не горит)
    image dct_ext_musclub_night_lantern_light = "mods/dublicate_completed/images/bg/coin/dct_ext_musclub_night_lantern_light.jpg" # Музклуб снаружи (ночь, свет от фонаря)
    image dct_ext_houses_night_lantern_light = "mods/dublicate_completed/images/bg/coin/dct_ext_houses_night_lantern_light.jpg" # Аллея ночью с подсветкой
    image dct_ext_houses_rain = "mods/dublicate_completed/images/bg/coin/dct_ext_houses_rain.jpg" # Аллея днём в дождь
    image dct_ext_library_rain = "mods/dublicate_completed/images/bg/coin/dct_ext_library_rain.jpg" # Бибилиотека снаружи днём в дождь
    image dct_int_library_rain = "mods/dublicate_completed/images/bg/coin/dct_int_library_rain.jpg" # Бибилиотека внутри днём в дождь
    image dct_int_library_rain_lamp = "mods/dublicate_completed/images/bg/coin/dct_int_library_rain_lamp.png" # Бибилиотека: включённая лампа
    image dct_ext_dining_hall_near_rain = "mods/dublicate_completed/images/bg/coin/dct_ext_dining_hall_near_rain.jpg" # Столовая близко днём в дождь
    image dct_int_dining_hall_people_rain = "mods/dublicate_completed/images/bg/coin/dct_int_dining_hall_people_rain.jpg" # Столовая внутри днём в дождь
    image dct_dormitory_at_range = "mods/dublicate_completed/images/bg/coin/dct_dormitory_at_range.jpg" # Общежитие у полигона из воспоминаний Александра
    
    
    
    image dct_ext_aidpost_after_rain = "mods/dublicate_completed/images/bg/coin/dct_ext_aidpost_after_rain.jpg" # Медпункт после дождя
    image dct_ext_dining_hall_away_after_rain = "mods/dublicate_completed/images/bg/coin/dct_ext_dining_hall_away_after_rain.jpg" # Столовая вдали после дождя
    image dct_ext_square_after_rain = "mods/dublicate_completed/images/bg/coin/dct_ext_square_after_rain.jpg" # Площадь после дождя
    image dct_ext_сentral_alley_from_dining_hall_to_west_after_rain = "mods/dublicate_completed/images/bg/coin/dct_ext_сentral_alley_from_dining_hall_to_west_after_rain.jpg" # Аллея от столовой до западных ворот после дождя
    image dct_ext_clubs_rain = "mods/dublicate_completed/images/bg/coin/dct_ext_clubs_rain.jpg" # Клуб кибернетиков (снаружи) во время дождя дождя
    image dct_int_clubs_male_rain = "mods/dublicate_completed/images/bg/coin/dct_int_clubs_male_rain.jpg" # Клуб кибернетиков (внутри) во время дождя дождя
    image dct_ext_another_clubhouse_day = "mods/dublicate_completed/images/bg/coin/dct_ext_another_clubhouse_day.jpg" # Второе здание клубов (заброшенное)
    ...
    image dct_ext_square_night_darkest = "mods/dublicate_completed/images/bg/coin/dct_ext_square_night_darkest.jpg"
    image dct_ext_square_night_crop = "mods/dublicate_completed/images/bg/coin/dct_ext_square_night_crop.jpg"
    image dct_ext_square_night_purple = "mods/dublicate_completed/images/bg/coin/dct_ext_square_night_purple.jpg"
    image dct_ext_square_night_purple_blur = "mods/dublicate_completed/images/bg/coin/dct_ext_square_night_purple_blur.jpg"
    image dct_ext_square_night_purple_blur_HD = im.Scale("mods/dublicate_completed/images/bg/coin/dct_ext_square_night_purple_blur_HD.jpg",1920,1080)
    image dct_ext_square_profile_view_night = "mods/dublicate_completed/images/bg/coin/dct_ext_square_profile_view_night.jpg" # Площадь с боку ночью, вид на Генду и админ. корпус
    image dct_ext_square_profile_view_night_darker = "mods/dublicate_completed/images/bg/coin/dct_ext_square_profile_view_night_darker.jpg"
    image dct_ext_square_profile_view_night_darkest = "mods/dublicate_completed/images/bg/coin/dct_ext_square_profile_view_night_darkest.jpg"
    ...
    image dct_ext_bus_road = "mods/dublicate_completed/images/bg/coin/dct_ext_bus_road.jpg"
    image dct_ext_outside_field = "mods/dublicate_completed/images/bg/coin/dct_ext_outside_field.jpg"
    image dct_author_room = "mods/dublicate_completed/images/bg/coin/dct_author_room.jpg"
    ...
    image dct_sh_in_cage = im.Composite((1920, 1080), (0, 0), 'mods/dublicate_completed/images/cg/coin/dct_int_clubs_male2_for_cage.jpg', (0, 0), 'mods/dublicate_completed/images/cg/coin/dct_sh_in_cage.png') # Шурик в клетке для чтения воспоминаний
    image dct_sh_in_cage_with_pushbutton = im.Composite((1920, 1080), (0, 0), 'mods/dublicate_completed/images/cg/coin/dct_int_clubs_male2_for_cage.jpg', (0, 0), 'mods/dublicate_completed/images/cg/coin/dct_sh_in_cage_with_pushbutton.png') # Шурик в клетке для чтения воспоминаний (с кнопкой и проводом)
    image dct_empty_in_cage = im.Composite((1920, 1080), (0, 0), 'mods/dublicate_completed/images/cg/coin/dct_int_clubs_male2_for_cage.jpg', (0, 0), 'mods/dublicate_completed/images/cg/coin/dct_empty_in_cage.png') # Пустая клетка для чтения воспоминаний
    image dct_sky_over_flowerbed_behind_library = "mods/dublicate_completed/images/cg/coin/dct_sky_over_flowerbed_behind_library.jpg" # Небо над головой в обраблении крон
    image dct_mz_and_el_sitting_on_bench_near_flowerbed = "mods/dublicate_completed/images/cg/coin/dct_mz_and_el_sitting_on_bench_near_flowerbed.jpg" # Эл и Женя сидят на лавочке
    
    image dct_mz_and_el_sitting_on_grass = "mods/dublicate_completed/images/cg/coin/dct_mz_and_el_sitting_on_grass.jpg" # Эл и Женя сидят на траве под деревьями
    image dct_convoy_of_trucks = "mods/dublicate_completed/images/cg/coin/dct_convoy_of_trucks.jpg" # Колонна Уралов
    ...
    image dct_dv_two_pieces_casual = im.Scale("mods/dublicate_completed/images/cg/coin/dct_dv_two_pieces_casual.png",1536,1620)
    image dct_dv_two_pieces_pioneer = im.Scale("mods/dublicate_completed/images/cg/coin/dct_dv_two_pieces_pioneer.png",1536,1620)
    image dct_dv_argue = "mods/dublicate_completed/images/cg/coin/dct_dv_argue.jpg"
    image dct_dv_argue sternsmile = "mods/dublicate_completed/images/cg/coin/dct_dv_argue_sternsmile.jpg"
    image dct_sl_clean_square_1 = im.Alpha("mods/dublicate_completed/images/cg/coin/dct_sl_clean_square_1.jpg",0.7)
    image dct_sl_clean_square_2 = im.Alpha("mods/dublicate_completed/images/cg/coin/dct_sl_clean_square_2.jpg",0.7)
    image dct_sl_clean_square_3 = im.Alpha("mods/dublicate_completed/images/cg/coin/dct_sl_clean_square_3.jpg",0.7)
    image dct_sl_clean_square_4 = im.Alpha("mods/dublicate_completed/images/cg/coin/dct_sl_clean_square_4.jpg",0.7)
    image dct_sl_clean_square_5 = im.Alpha("mods/dublicate_completed/images/cg/coin/dct_sl_clean_square_5.jpg",0.7)
    image dct_sl_clean_square_6 = "mods/dublicate_completed/images/cg/coin/dct_sl_clean_square_6.jpg"
    ...
    image dct_int_bus_purple = "mods/dublicate_completed/images/cg/coin/dct_int_bus_purple.jpg"
    image dct_d1_uv = "mods/dublicate_completed/images/cg/coin/dct_d1_uv.jpg"
    image dct_d1_uv_2 = "mods/dublicate_completed/images/cg/coin/dct_d1_uv_2.jpg"
    ...
    image dct_road_anim:                  # Дорога (автобус едет в лагерь)
        "mods/dublicate_completed/images/anim/coin/dct_road_6.jpg"
        pause 0.6
        "mods/dublicate_completed/images/anim/coin/dct_road_5.jpg" with dissolve_fast
        pause 0.6
        "mods/dublicate_completed/images/anim/coin/dct_road_4.jpg" with dissolve_fast
        pause 0.6
        "mods/dublicate_completed/images/anim/coin/dct_road_3.jpg" with dissolve_fast
        pause 0.6
        "mods/dublicate_completed/images/anim/coin/dct_road_2.jpg" with dissolve_fast
        pause 0.6
        "mods/dublicate_completed/images/anim/coin/dct_road_1.jpg" with dissolve_fast
        pause 1
    ...
    image dct_clubs_male_comp_sh_crumble:                  # Шурик фрагментируется на экране монитора (выводить на экран в позиции xcenter 0.5 ycenter 0.45)
        "mods/dublicate_completed/images/anim/coin/dct_clubs_male_comp_sh2.png"
        xcenter 0.5 ycenter 0.45
        pause 1
        "mods/dublicate_completed/images/anim/coin/dct_clubs_male_comp_sh3.png" with dissolve_fast
        xcenter 0.5 ycenter 0.45
        pause 1
        "mods/dublicate_completed/images/anim/coin/dct_clubs_male_comp_sh4.png" with dissolve_fast
        xcenter 0.5 ycenter 0.45
        pause 1
        "mods/dublicate_completed/images/anim/coin/dct_clubs_male_comp_sh5.png" with dissolve_fast
        xcenter 0.5 ycenter 0.45
        pause 1
        "mods/dublicate_completed/images/anim/coin/dct_clubs_male_comp_sh6.png" with dissolve_fast
        xcenter 0.5 ycenter 0.45
        pause 1
        "mods/dublicate_completed/images/anim/coin/dct_clubs_male_comp_sh7.png" with dissolve_fast
        xcenter 0.5 ycenter 0.45
        pause 1
        "mods/dublicate_completed/images/anim/coin/dct_clubs_male_comp_sh8.png" with dissolve_fast
        xcenter 0.5 ycenter 0.45
        pause 1
        "mods/dublicate_completed/images/anim/coin/dct_clubs_male_comp_sh9.png" with dissolve_fast
        xcenter 0.5 ycenter 0.45
        pause 1
    ...
    image dct_ball_to_ball_1 = "mods/dublicate_completed/images/anim/coin/dct_ball_to_ball_1.jpg"
    image dct_ball_to_ball_2 = "mods/dublicate_completed/images/anim/coin/dct_ball_to_ball_2.jpg"
    image dct_ball_to_ball_3 = "mods/dublicate_completed/images/anim/coin/dct_ball_to_ball_3.jpg"
    image dct_ball_to_ball_4 = "mods/dublicate_completed/images/anim/coin/dct_ball_to_ball_4.jpg"
    image dct_ball_to_ball_5 = "mods/dublicate_completed/images/anim/coin/dct_ball_to_ball_5.jpg"
    image dct_ball_to_ball_6 = "mods/dublicate_completed/images/anim/coin/dct_ball_to_ball_6.jpg"
    image dct_ball_to_ball_7 = "mods/dublicate_completed/images/anim/coin/dct_ball_to_ball_7.jpg"
