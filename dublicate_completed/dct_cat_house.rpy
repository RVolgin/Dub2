...
label dct_the_first_life:
    ...
    "Были бы дома хозяева — они бы не допустили такого. Домашних животных запрещалось держать в посёлке, и котенка протащили нелегально, но хозяйка укатила на материк, хозяин ушёл на работу, и снять безымянную кошку с окна оказалось некому."
    stop ambience
...
label dct_creature:
    ...
    "Заблудиться было невозможно. Держись вдоль реки и отойди от поселка как можно дальше. Самым трудным было пролезть сквозь дырку в заборе, но дальше всё прошло как по маслу."
    ...
    "Удалившись от поселка километров на пять и почти упёршись здесь в Периметр, Светлана остановилась. Она когда-то читала, что кошки не отходят в своих странствиях от дома дальше, чем на два километра, поэтому посчитала расстояние достаточным."
    stop music fadeout 1
...
label dct_felinoid:
    ...
    show uv_spy_wild with dspr
    d_to "Кто сказал, что трудно ловить чёрную кошку в темной комнате? Это только вопрос системного подхода и правильной методики. Хоть ты и прыгаешь по узлам сети, как кошка по мебели."
