...
label dct_foreign_land_dyn:
    ...
    show dct_road_bus_BTR:
        ...
        pause 1.5
        linear 1.5 alpha 1
    "\n И первое, что он увидел — был зад знакомого автобуса, торчащий из кювета.{w} Тут же стоял побитый БТР, около которого кто-то бинтовал кого-то. Но это было неважно, потому что на пассажирах автобуса не было ни царапинки, но и живых среди них тоже не было.{w} Некоторые ещё дышали, но это ненадолго."
