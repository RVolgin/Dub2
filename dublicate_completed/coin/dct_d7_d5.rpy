...
label dct_d7_d5:
    $ save_name = u"Дубликат. Монетка в фонтане -- d7-d5"
    $ night_time()
    ...
    scene dct_int_coaching_room2_night
    "Семен ворочался, все никак не мог уснуть, пока Ульяне не надоело и та не шикнула на Семена."
    us "Сёмк, вообще ты должен сейчас сопеть носом в угол, а ты дыру в матрасе протираешь. С тобой все в порядке?"
    ...
    "Лене снилась женщина, тянущая к ней руки. Глядящая ей в глаза — кто первый сдастся и отведет взгляд."
    ...
    "Мальчик дремлет у нее на плече, а Мику хочет повернуть голову, чтобы посмотреть на него и понимает, что этого нельзя делать, что тогда случится что-то непоправимое."
    ...
    "Ближайший дежурный фонарь освещал хозяйственные ворота, да вход в столовую был ярко освещен своими фонарями."
    "Луна, выросшая в три четверти, висела где-то за лесом, но света звезд хватало для глаз."
    "Семен и Ульяна, укрывшись одной курткой на двоих, сидели на крыльце спортзала и смотрели поверх главной аллеи, на пустой пляж и слабо мерцающую реку за ним."
    ...
    us "Сём, помнишь, в наш первый цикл, когда мы ходили за Алисой в бомбоубежище. Ты еще спросил о звездах, что-то вроде: «Интересно, здесь те же звезды, что и дома?»"
    me "Помню."
    us "Вот и я себе сейчас этот вопрос задаю."
    us "Знаешь, я думаю, что звезды для всех общие. И если мы отсюда сможем улететь к ним, то, вернувшись назад, окажемся где угодно. Здесь, в соседнем узле, в…"
    us "В материнском мире.{w=.5} Я название придумала, а то мы все «снаружи», да «снаружи»."
    me "В мирах, Рыжик."
    me "Я так подозреваю, что материнский мир не один."
    me "Тот Пионер, который приходил ко мне. И Семен, который сюда приедет через два дня, которого все ждет Лена. Они ведь из разных миров."
    ...
    $ persistent.sprite_time = "night"
    "Семен замолчал, не желая продолжать, вспомнив еще, мельком оброненные бабулей слова о том, что когда удалось пробиться сюда, оказалось, что здесь уже бывали люди."
    window hide
    ...
    with blinds
    window auto
    d_gd "Попадешь в двести первый узел, увидишь там развалины домов."
    ...
    d_jn_old "Ты снова пришел сюда. Неужели ты не понимаешь, что только разрушаешь себя самого? Что ты просто отдаешь кусочек себя каждый раз, когда приходишь? Что мы даже не фантомы? Ты же знаешь, чем все кончается."
    "«А может я и хочу, чтобы все так и кончилось», — думает во сне Шурик.{w} Нет, не Шурик, а тот человек, чей сон он видит."
    "Все уже много раз повторялось, в том числе и этот сон, и этот человек снова молча смотрит на Яну."
    "Кирпичная остановка; бетонный забор с одной стороны улицы и глинобитная стена, которую офицеры с полигона называют «дувал» — с другой; пыльные пирамидальные тополя, растущие в два ряда между проезжей частью и забором; железные ворота в заборе, сейчас приоткрытые; — это все воспринимается попутно."
    ...
    d_jn_young "Я телефон в трех местах записала и еще выучила, вот!"
    ...
    show dct_dream_sh_third_BTR_bus behind d_jnjn with dissolve
    "С брони спрыгивает незнакомый майор, отдает честь:"
    show dct_dream_sh_third_major at right with dissolve
    d_maj "Все готово?{w=0.5} Хорошо."
    "Майор поворачивается к женщинам."
    d_maj "Садитесь пожалуйста в автобус."
    hide d_jnjn with dissolve
    ...
    "Автобус не успеет обернуться, поэтому через час за вами подойдет Урал, будьте дома."
    ...
    "Майор еще раз отдает честь, забирается на броню, БТР выпускает в небо облако черного дыма, взревывает мотором и маленький конвой уезжает."
    ...
    th "Может быть, я еще сплю? И мне только снится, что я проснулся?"
    ...
    $ persistent.sprite_time = "day"
    window auto
    "У Мику со вчерашнего вечера было прекрасное настроение, и даже серьезный сон, приснившийся под утро, этого настроения не нарушил."
    scene dct_mi_piano1 with squares
    "В кои-то веки у нее попросили помощи, пусть даже и нужно было всего лишь играть на фортепиано для Саши и Максима."
    "А параллельно можно было разговаривать и общаться, и никто от нее не отмахивался."
    ...
    "А по японски это будет «Хатсуне Мику», а еще это моё имя, Хатсуне Мику."
    ...
    with dspr
    "Потом, видимо что-то решив для себя, она достала из тумбочки серую канцелярскую папку-скоросшиватель и протянула ее Мику."
    show dct_mz_1_binder_far at cleft with dissolve
    mz "Вот, почитай. Мне это дала Лена, а той принес наш физрук, говорит, что это сочинила одна его знакомая."
    hide dct_mz_1_binder_far
    show dct_mi_3_binder_far:
        xanchor .0 xpos .45
    with dissolve
    show d_mz sceptic glasses pioneer far as mz with dspr
    mz "И мне интересно твое мнение обо всем этом."
    ...
    with dissolve
    "Мику открыла папку на середине, прочитала пол странички текста."
    ...
    "У Жени же все вертелась в голове характеристика Жанны из пьесы: «Жанна, заведующая библиотекой. Любит книги, а людей не вполне понимает и потому опасается»."
    play sound sfx_open_water_sink
    scene bg ext_washstand2_day with dissolve
    stop sound fadeout 1
    play sound_loop sfx_water_sink_stream fadein 0.2
    "Когда начала читать — не обратила внимания, а потом, когда начали все больше и больше вылазить параллели с «Совенком» и его обитателями, то вспомнила и не то, чтобы обиделась, но что-то ущипнуло за сердце."
    play sound sfx_close_water_sink
    stop sound_loop
    scene bg ext_houses_day
    show mz normal glasses pioneer
    with dissolve
    "Женя применила к себе эту характеристику и вообще, все что касалось Жанны и признала:"
    ...
    with dissolve
    "Еще одна линейка, напоминание про то, что сегодня шестой день смены, о том, что завтра по Плану мероприятий будет спортивный праздник и комментарий Семена: «Никакой обязаловки, но призы будут»."
    ...
    th "Внешность ладно, внешность неизвестный мне автор даже сильно приукрасил, но вот характер, тут все правда."
    ...
    "Зашел Семен за тренерскими методичками."
    ...
    hide d_sf2
    th "Заметил, надо же."
    extend " Правда, это его обязанность, но все равно."
    ...
    me "Раньше ты бы рычала на меня, а сейчас только очками поблескиваешь из своего угла."
    th "Конечно иначе. Прочитала этот чертов текст и оказалось, что я боюсь вас, людей."
    th "Спросить, откуда он взялся, текст этот, будь он неладен?"
    extend " Куча вопросов про него."
    show d_sf normal sport with dspr
    "Не было в программах, заложенных системой в Женю, правил поведения в подобных ситуациях, не было их и в программах, заложенных в нее создателями-людьми."
    ...
    "Это было не главное о чем хотела сказать Женя, но это было хоть что-то."
    show d_sf serious sport with dspr
    mz "Семен, я у Лены вчера брала почитать одну распечатку."
    mz "Скажите…{w=.5} Скажи, кто ее настоящий автор?"
    show d_sf smile sport with dspr
    me "Понравилось?"
    
    # "Семен присел в кресло, напротив конторки заведующей."  # По канону
    
    show d_sf normal sport with dspr
    me "Ее действительно написала Мику Хатсуне.{w} Правда, это не та Мику, которую ты знаешь."
    me "Ну, а то, что персонажи такие узнаваемые…"
    show d_sf serious sport with dspr
    me "Она вас не знает, и я ей о вас не рассказывал, в этом я уверен."
    
    # "Семен сидел на краешке кресла, подавшись вперед и смотрел на Женю не отрываясь. Как будто ждал от нее чего-то."    # По канону
    
    "Семен пристально смотрел на Женю, как будто ждал от нее чего-то."
    "Смотрел серьезно, вовсе без улыбки, а чуть сжав губы, но Жене так было даже легче."
    th "Серьезный разговор двух серьезных людей."
    "И никто не посмеется над ней, и никто не отмахнется от нее. Просто обмен информацией."
    "Женя узнала про автора распечатки, а взамен сейчас скажет о том, что ее беспокоит."
    ...
    show d_sf serious sport with dspr
    me "Когда кто-то, за редчайшим исключением, приходит в библиотеку, у тебя такой вид, будто ты хочешь немедленно выпроводить посетителя, отвлекшего тебя от важного дела."
    ...
    # "Семен поднялся, выровнял стопку полученных методичек, попросил разрешения оставить их у себя и такое разрешение получил."  # По канону
    
    "Семен выровнял стопку полученных методичек, попросил разрешения оставить их у себя и такое разрешение получил."
    ...
    "И уже с порога непонятно добавил, с какой-то обреченной грустью в голосе, как говорят о застарело больном зубе:"
    ...
    show d_mz sceptic glasses pioneer at center:
        xzoom -1.0
    with squares
    "После ухода Семена Женя выбралась из-за своей конторки, подошла к зеркалу и, глядя в глаза своему отражению, проговорила:"
    ...
    mz "Как там у классика: „Полюбите нас черненькими!“ Так честнее будет, чем я начну фальшиво всем улыбаться."
    stop ambience fadeout 1
    show black with dissolve
    window hide
    ...
    th "Интересно, если собрать все детские воспоминания всех Алис, удастся ли восстановить все мое детство?"
    th "А если собрать всех Алис вместе, может, мы просто сольемся в одну Алису-настоящую?"
    ...
    th "Вот и умничка."
    extend " Этот лагерь еще часок обойдется без меня."
    ...
    extend " И исчезающие со вспышкой света при определенных условиях."
    th "Вот так исчезнешь, оставив после себя вспышку света, и всё, и привет сестренка."
    "Плохо было то, что не с кем было посоветоваться.{w} Сенька с Ульяной, со слов бабули, говорили что-то о том, что пионеры-двойники, они называли их «субъектами», не могут находиться одновременно в одном узле, о преимуществах «своего» узла, по принципу «дома и стены помогают», об уровне развития личности субъекта, но все это была голая теория."
    ...
    th "А тут еще за горнистом присмотреть надо."
    extend " Начал-то он хорошо, интересно, что в нем к следующему циклу изменится."
    "Мрачное настроение еще держалось, но, кажется, опять появился интерес к жизни своего лагеря."
    nvl hide dissolve
    nvl clear
    pause 0.15
    ...
    window auto
    el "Чуть левее датчик, еще левее, еще…{w} Стоп{w=0.3}, сейчас чуть-чуть правее.{w} Так, хорошо."
    el "Шурик, сейчас чуть выше.{w} Стой{w=0.3}, опусти назад, еще опусти{w=0.3}, нет, верни как было.{w} Всё, зажимай, поймали."
    ...
    with dissolve_fast
    el "Попытаемся переписать те объемы информации, которая в них есть и попытаемся ее расшифровать. Всё, что есть в нашем подсознании, всё, что есть в нашей памяти."
    "Увлекшийся Электроник заговорил как герой его любимой фантастики шестидесятых годов."
    ...
    sa "Я верю, что все у вас, мальчики, получится. Но я к вам за помощью, раз вы освободились."
    sa "Сережа, в половине библиотеки свет только что погас, посмотри, пожалуйста."
    ...
    el "Шурик, а может, ты сходишь? А я пока тут все поотключаю и порядок до обеда наведу."
    ...
    with dspr
    sh "Иди, Сергей. На обеде увидимся. А завтра уже займемся экспериментом."
    hide sl with dissolve
    hide sh with dissolve
    "И, показывая, что разговор окончен, Шурик начал отключать приборы и собирать все с верстака."
    ...
    with wipeleft
    "Но, к удивлению Сергея, Саша, на перекрестке не свернула налево, в сторону музыкального кружка и короткой дороги к своему домику. А наоборот, догнав его, и подстроившись под его шаг, пошла рядом."
    show 3500_el surprise pioneer briefcase with dissolve_fast
    el "Ты на пляж? Я думал ты к себе свернешь."
    ...
    el "А зачем мне объясняться, когда все уже сказано? Только нервы мотать."
    ...
    "Саша с Сергеем прошли по площади, обогнули Генду и синхронно помахали рукой Лене, сидящей на своем привычном месте и делающей какие-то заметки в блокноте."
    show un normal pioneer far
    show sl smile pioneer
    with dissolve_fast
    sa "Сережа, а может, все еще не было сказано окончательно? Может, Женя сама не уверена ни в чем?"
    ...
    with dissolve_fast
    el "Сашенька. Я простой как отвертка, и привык иметь дело с техникой, которая либо работает, либо нет. И всегда можно найти причину, почему она не работает. И «нет» всегда означает только «нет»."
    ...
    hide sl2
    with dissolve_fast
    sa "Но… Я же вижу, что ты Жене нравишься. Что она злится, когда тебя не видит, или когда видит, но ты на нее не смотришь, или когда кто-то из девочек с тобой разговаривает."
    ...
    sa "Сережа, здесь, на этом, как ты выразился, «женском» языке может говорить только Катя. Умеет еще Лена, но она делать этого никогда не будет, и точно не умеет Женя."
    ...
    sa "Даже ее шутки, когда она просто хочет, чтобы человек улыбнулся, обычно воспринимаются как колкости."
    show 3500_el shocked pioneer briefcase with dspr
    sa "Или же она накрутила сама на себя. Потому что если у неё, с ее характером, до лагеря были проблемы в отношениях с людьми, она могла посчитать себя никому не нужной."
    show 3500_el upset pioneer briefcase with dspr
    sa "Дайте друг другу еще один шанс, вот что я хотела сказать."
    ...
    th "Эдак никаких рубашек не напасешься."
    ...
    th "Может, все-таки Сашу помощником назначить?"
    extend " Алиса только за будет."
    th "Нет, не вариант, Саша занята собой и каждым пионером, попавшим в ее поле зрения по отдельности."
    show mt sad pioneer close with dspr
    th "Никому нет дела до лагеря в целом, наверное даже Семену."
    show 3500_el shy pioneer briefcase:
        zoom 0.75 xcenter .71
    show mz shy glasses pioneer far:
        xcenter 0.6
    with dissolve
    "В столовую зашли еще двое: Сыроежкин и Женя."
    ...
    "И вспомнилась еще одна Ленина работа, совсем свежая, висящая в тренерской."
    stop ambience fadeout 1
    ...
    # Есть задумка менять цвет имени персонажа "Доносящийся голос" с помощью переменной (к примеру [d_voice_color]), но эта схема почему-то отказывается работать, параметр color не хочет эту переменную понимать.
    ...
    # d_vocal_noise "…Женю прозондировать, не все так безнадежно, тяжело, но не…"
    ...
    d_vocal_noise_d_ma "Тётя Алиса, а если мне…"    # Голос Максима
    d_vocal_noise_me "Вот и вопрос, Рыжик, как привести сюда чужую футбольную команду? Или наших туда…" # Голос Семёна
    d_vocal_noise_dv "… собрание отряда, племянничек. Готовься."    # Голос Алисы
    d_vocal_noise_mi "Леночка, а кто же это написал? Мы с Сашей думали, но так и не придумали ничего."  # Голос Мику
    d_vocal_noise_sh "…Женю прозондировать, не все так безнадежно, тяжело, но не…"  # Голос Шурика. Наверное. Ну а кого ещё...
    d_vocal_noise_d_vi "Катя, мы что, на пляж не идем?" # Голос Витьки
    d_vocal_noise_d_oz "Вася, ты после обеда не уходи никуда, пожалуйста. Я хочу…"  # Голос Оксаны
    d_vocal_noise_us "Сёмк. Я, наверное, смогу попробовать. Но уговаривать обеих вожатых будешь ты."    # Голос Ульяны
    ...
    "Для ускорения работ корпус решили не делать, и сейчас эти платы рядком лежали на рабочем столе, на плоском листе шифера, соединенные между собой экранированными проводами. Видеомагнитофон, заряженный чистой кассетой, стоял тут же."
    ...
    "Шурик вышел на крыльцо и запер двери на висячий замок, после чего обошел здание и влез внутрь через окно."
    show sh normal_smile pioneer close with dissolve:
        xcenter .6
        easeout 1.5 xcenter 1.25
    "Включил установку на разогрев, а сам прямо на включенной установке стал наращивать провод, ведущий к кнопке «Пуск»."
    stop ambience fadeout 1
    show black with dissolve
    ...
    scene dct_sh_in_cage with squares
    ...
    "Теперь — главное, надо было высидеть на табурете десять минут, не меняя положения головы и стараясь ни о чем не думать."
    $ renpy.music.set_volume(0.05)
    play music "<from 32.0 loop 0.0>mods/dublicate_completed/Sounds/music/dreamers_of_the_day.ogg" fadein 1.5
    ...
    "Кто-то трогал висячий замок и дергал входную дверь, кто-то пытался заглянуть в окна, благо Шурик предусмотрительно задвинул шпингалеты и задернул занавески."
    "Из-за двери послышался голос Сыроежкина:"
    el "Шурик, ты здесь?"
    play sound "<to 1.05>sound/sfx/knock_door_closed_hard2.ogg"
    stop music fadeout 1.5
    "Замок подергали еще пару раз и две пары ног потопали с крыльца."
    stop music
    ...
    "После этого восстановил в кружке все как было, вылез в окно и отправился на пляж."
    ...
    show black:
        ...
        pause 1.3
        linear 1 alpha 1
    "До расшифровки результатов делать Шурику было совершенно нечего, а работать компьютеру предстояло еще несколько часов."
    show black as black2 with dspr
    ...
    with dissolve
    "Ульяна и Семен валялись на пляже."
    ...
    hide 3500_sh
    with dissolve
    "Средний отряд приходил по расписанию и за ними присматривал кто-то из персонала или помощник вожатой, младшему же отряду требовались еще и команды, выгоняющие октябрят из воды и разрешающие им снова лезть в воду."
    show d_sf smile swim
    show d_us normal swim
    with dspr
    "На деле же мелкие были довольно самостоятельными людьми и обходились без эксцессов на воде, единственное, что приходилось их выгонять оттуда, когда они уж совсем посинеют и общаться с ними, но это Семену было только в удовольствие."
    ...
    me "Есть такая работа, называется „взросление“, и неважно, в какой ты фазе, когда тебе все равно семь, восемь, девять лет, ты все равно взрослеешь. Если я могу помочь хорошим людям — почему нет?"
    ...
    with dissolve
    us "— Оля, тебе пять лет?{w=0.4} Ты можешь бросать песком сколько угодно, но потом сама всех поведешь к доктору, глаза промывать.{w} Да-да, именно ты поведешь."
    scene dct_ext_beach_day_lifesaving_shield
    show d_us serious swim:
        xcenter 0.84 ypos -0.05
    with dissolve
    us "Егорка, если тебе нравится девочка, то просто скажи ей об этом, а не щелкай по спине тесьмой от купальника."
    scene dct_ext_beach_day_with_pass_train
    show d_us serious swim:
    ...
    with dissolve
    "А тут еще Катерина обращает на себя внимание."
    ...
    "Витька потащил ее в воду, получил резкую отповедь, ничего не понял, еще покрутился вокруг и полез купаться со всем отрядом, а Катя осталась сидеть одна под грибком."
    scene dct_ext_beach_day_with_pass_train
    show d_sf normal swim:
        xcenter 0.35 ypos 0.2
    show d_us normal swim:
        xcenter 0.65 ypos 0.09
    with dissolve
    us "Сём, Катя переживает. Только не пялься на нее, а то убежит."
    me "Конечно переживает. В прошлом цикле все вокруг нее бегали, а тут Макс взял и перерос её."
    ...
    me "Жалко ее, но одна мудрая женщина сказала, что такие вещи и превращают организмы в людей."
    ...
    with dspr
    us "И знаешь, Сём, мне сейчас кажется, что мне внутри всегда было девятнадцать, пока я тебя ждала. А когда встретила тебя, все на свои места встало."
    show dct_ext_beach_day_lifesaving_shield
    ...
    mz "Ничего я не знаю, Серг… Сережа. Все, что я знаю, я прочитала в книгах. Но я же не идиотка восторженная, я же понимаю, что книги и реальная жизнь — это разные вещи."
    ...
    mz "Это то, ради чего ты позавчера бегал в библиотеку каждые полчаса? Пойдем."
    mz "Все равно в библиотеку никто не ходит, кроме Лены, а она сегодня уже была. Да и портфель этот тебе надо на место вернуть."
    scene bg ext_houses_day
    show 3500_el laugh pioneer briefcase:
        xcenter .35 ycenter.833
    show d_mz smile3 glasses pioneer at cright
    with squares
    "Это было новое для «Совенка» событие: по аллее, сперва по боковой, потом, пройдя по площади, по главной шли Женя и Сыроежкин и о чем-то разговаривали."
    "Они еще не держались за руки, но уже и не отворачивались друг от друга, и, о чудо, Женя даже улыбалась."
    ...
    th "И этого кого-то зовут Семен."
    th "Сейчас опять начнет уговаривать. А закончится все полетевшим к чертям планом мероприятий и срывом…"
    ...
    "Но он же готовый начальник еще одного лагеря, но почему-то остается здесь."
    show d_sf smile swim:
    ...
    mt "Семен, скажи, что ты будешь делать, если я тебе сейчас не отвечу?"
    me "Тогда…"
    ...
    me "Тогда я буду действовать так, будто получил твое согласие."
    show d_sf laugh swim:
        linear 0.5 alpha 0
    ...
    th "Время-то к отбою, оказывается. Скоро темнеть начнет."
    "Оглядываюсь, все тихо и спокойно. Никто не убился, никто не подрался, никто, кажется, не убежал."
    "Вон идет один из Семеновых футболистов с подружкой. Несет в руках кораблик, вырезанный из коры."
    ...
    th "Как бы еще Семена позлить, время потянув?"
    th "Вот!"
    ...
    mt "Семен Семенович, не изволите ли чаю?"
    "Пионеров в пределах слышимости нет, так что можно и подурачиться, но насчет чаю я вполне серьезна."
    me "Премного обяжете, Ольга Дмитриевна."
    "Одна из проблем состоит в том, что мы знакомы уже черт знает сколько и уже угадываем реплики друг друга до того, как кто-то из нас откроет рот."
    ...
    show int_house_of_mt_sunset:
        pause 1.6
        linear 1 ycenter -0.5
    "Появляется Семен, достает из шкафа удлинитель, разматывает его и протягивает на крыльцо, выносит на крыльцо чайник и включает в розетку."
    me "— Оль, черный или зеленый?"
    mt "Давай зеленый сегодня."
    show d_sf normal pioneer with dspr:
        pause 1
        ease 1 xcenter .28
        linear 0.5 ypos 0.2
    "Все, я сажусь в один шезлонг, Семен разворачивает второй, ставит его с другой стороны крыльца и тоже усаживается, лицом ко мне."
    show d_us smile dress:
        xcenter 1.2 ypos -0.05
        pause 1
        easein 1.5 xcenter 0.55
    "Слышу шлепанье босых ног по дорожке, этот ритм полубега-полушага ни с чьим не спутаешь — Ульяна."
    show d_us smile dress:
        linear 0.5 ypos 0.09
    show d_sf smile pioneer with dspr
    "Усаживается на крыльцо.{w} Теперь, когда вся администрация лагеря в сборе, можно начинать совещание."
    "Семен смотрит, как устраивается Ульяна, и я вижу нежность в его глазах. Поэтому не начинаю, пока он не примет деловой вид."
    ...
    $ persistent.sprite_time = "sunset"
    mt "Ну-с, что вы сегодня приготовили для бедной задерганной вожатой, дорогие мои?"
