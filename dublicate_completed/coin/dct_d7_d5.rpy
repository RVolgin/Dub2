...
label dct_d7_d5:
    ...
    "Майор ещё раз отдает честь, забирается на броню, БТР выпускает в небо облако чёрного дыма, взрёвывает мотором, и маленький конвой уезжает."
    ...
    mz "И мне интересно твое мнение обо всём этом."
    ...
    with dissolve
    "Ещё одна линейка, напоминание про то, что сегодня шестой день смены, о том, что завтра по Плану мероприятий будет спортивный праздник, и комментарий Семёна: «Никакой обязаловки, но призы будут»."
    ...
    # "Семен сидел на краешке кресла, подавшись вперед и смотрел на Женю не отрываясь. Как будто ждал от неё чего-то."    # По канону
    ...
    "И никто не посмеётся над ней, и никто не отмахнется от неё. Просто обмен информацией."
    ...
    th "Интересно, если собрать все детские воспоминания всех Алис, удастся ли восстановить всё мое детство?"
    ...
    th "Вот и умничка."
    extend " Этот лагерь ещё часок обойдется без меня."
    ...
    show int_house_of_mt_sunset:
        pause 1.6
        linear 1 ycenter -0.5
    "Появляется Семён, достает из шкафа удлинитель, разматывает его и протягивает на крыльцо, выносит на крыльцо чайник и включает в розетку."
