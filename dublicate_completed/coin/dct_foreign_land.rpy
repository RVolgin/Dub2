...
label dct_foreign_land:
    ...
    "Началось все с того, что Женя пошутила в своей обычной манере, когда окружающим непонятно, что это: или шутка, или очередной укол."
    scene black
    show d_mz smile2 glasses pioneer close at center
    with squares
    mz "Тебе не поздно еще убежать и сделать вид, что ничего не было."
    "А Электроник понял все буквально."
    hide d_mz
    ...
    "Убеждать, что ее не так поняли, она не хотела, сказать в ответ: «Ну и скатертью дорога!» — не смогла. {w}Собиралась, но перехватило дыхание."
    
    scene dct_mz_and_el_sitting_on_grass with squares
    
    # "Были там еще, конечно, и другие слова, и, в результате, парочка, собирающаяся распасться, не успев сложиться, сидела на скамье. Все там же, в конце библиотечной аллеи, спрятавшись от всех за статуей читающего пионера, каждый на своем конце, и молчали, отвернувшись друг от друга."   # По канону
    
    "Были там еще, конечно, и другие слова, и, в результате, парочка, собирающаяся распасться, не успев сложиться, сидела в тени деревьев."
    "Все там же, в конце библиотечной аллеи, спрятавшись от всех за статуей читающего пионера, и устроившись на безопасном расстоянии. Сидели и молчали, стараясь не смотреть друг на друга."
    
    "Электроник держался за ручку все того же многострадального портфеля, все искал и не находил в себе силы встать, попрощаться и уйти в кружок.{w} Все-таки Жене он не нужен…"
    "Женя же все мучительно пыталась понять: что она сделала не так, отчего сейчас все рушится?"
    th "Сейчас он встанет и уйдет."
    extend " И всё."
    ...
    "Женя тоже поднялась и стояла, наклонив голову так, чтобы в очках отражалось садящееся Солнце, и произносила такие слова, какие сумела подобрать, когда поняла, что Сергей сейчас уйдет."
    "Что вот эта мелькнувшая между ними сегодня не любовь, не дружба, не влюбленность, а так, тень взаимной симпатии, это всё, что она получила и получит от жизни. Вообще всё."
    ...
    el "Понимаешь, Женя, я вдруг понял, что ты пускаешь солнечные зайчики очками мне в глаза не для того, чтобы дополнительно позлить меня, а чтобы спрятать от меня слезы.{w} И тогда увидел тебя."
    el "Не умную и симпатичную девочку, которая мне понравилась с первого дня и не стервозную грымзу."
    mz "\~ Ну спасибо. \~"
    el "А перепуганную, не знающую что ей делать, девушку, которая прячет свои испуг и растерянность под иронией.{w} Которая еле сдерживается, чтобы не дать себе разреветься в моем присутствии.{w} Которая действительно не умеет говорить о каких-то вещах."
    el "Я сам не умею, а та девушка — еще хуже. И я нарушил своё правило, рискнул и решил всё про нас двоих самостоятельно и в одиночку."
    mz "А стервозная грымза вдруг увидела твою простоту, Сережа."
    ...
    "А в тот день портфель упал на траву и Сергей, внезапно оказавшись напротив Жени, взял ее за запястья, и сказал, запинаясь, краснея и спотыкаясь через слово:"
    ...
    sa "Еще пару раз позанимаемся, чтобы у тебя все автоматически получалось, и можешь смело приглашать свою «тётю Алису»."
    show d_ma shy pioneer
    show mi smile pioneer far
    with dissolve_fast
    "Мику смотрела на Сашу с Максимом, стоящих рядом и еще разгоряченных после танца, и любовалась ими. Они так здорово смотрелись вдвоем, оба спортивные, светловолосые, голубоглазые и оба, одновременно, открытые и застенчивые.{w} Жалко даже, что они не вместе."
    show d_ma normal pioneer with dissolve_fast
    "И так неохота их отпускать, потому что они сейчас уйдут, и опять нужно будет сидеть тут в четырех стенах музыкального кружка, в надежде, что кто-то из пионеров вдруг захочет научиться играть на ксилофоне."
    mi "Максим, Саша, а может, вы дальше будете заниматься? Ко мне все равно никто не приходит, так что аккомпанемент я вам обеспечу."  
    ...
    show sl smile pioneer far:
        xcenter 0.56
    with slideawayup
    "Все трое вышли на веранду. Уже стемнело и жара отступила, была та самая комфортная температура, когда солнце уже не обжигает, а, в то же время, прогревшиеся за день воздух и земля отдают достаточно теплоты, не давая мерзнуть."
    show sl smile pioneer at center with dissolve
    sa "Давайте посидим еще. Не хочется расходиться."
    ...
    "Они присели, вытянув ноги."
    $ renpy.music.set_volume(0.4)
    play sound_loop dct_sfx_record_crackling fadein 1
    pause 0.5
    play music [music_list['so_good_to_be_careless'], "<silence 1.0>", music_list['forest_maiden'], "<silence 1.0>", music_list['farewell_to_the_past_full'], "<silence 1.0>", music_list['reflection_on_water'], "<silence 1.0>", music_list['what_do_you_think_of_me'], "<silence 1.0>"] fadein 2     # Очередь из музыкальных файлов с паузами в 1 секунду между ними

    "Мику еще на минутку вернулась в кружок, чтобы поставить там пластинку с музыкой и приоткрыть окно."
    ...
    show mi upset pioneer with dissolve_fast
    sa "Собрание не для того, чтобы тебя не принять, а для того, чтобы ты имел возможность отказаться. Потому что понять, что тебя ожидает, ты еще не можешь. Но, если внутренний голос против, то лучше будет к нему прислушаться."
    show sl smile pioneer with dspr
    sa "Так мне вчера Лена сказала. Только не выдавайте меня."
    show d_ma smile pioneer
    show mi normal pioneer
    with dissolve_fast
    "Они посидели еще немного, обсуждая странности в поведении Лены и Алисы. Вспомнили и про физруков."
    show d_ma normal pioneer
    ...
    show sl smile2 pioneer with dissolve_fast:
        ypos 0.19
        linear 0.5 ypos 0.0
    sa "Пойду я, спать скоро, а надо еще душ после танцев принять."
    show sl smile pioneer with dissolve_fast
    sa "Максим, я и для тебя душ зарезервировала у Ульяны. Пошли в спортзал, я тебя вперед пропущу, а то тебе еще отбой играть."
    show d_ma smile pioneer:
        linear 0.5 ypos 0.0
    ...
    "А Мику смотрела вслед Максиму, уходящему по освещенной аллее, и думала, что пусть эти двое и не влюблены друг в друга, но кажется, у Саши вот-вот появится или уже появился хороший друг, и это здорово."
    $ night_time()                        # Прописано, чтобы при обратной перемотке цвета не сбивались.
    $ persistent.sprite_time = "night"
    th "Потому что Леночка, она замечательная девушка, но иногда ее бывает так трудно понять."
    stop ambience fadeout 1
    ...
    "Потому что завтра, во-первых, будет неудобно перед напарником за то, что первое испытание провел без него. А, во-вторых, вдруг там записалось что-то такое, за что потом перед Сергеем будет стыдно."
    ...
    hide el with dissolve
    $ persistent.sprite_time = "day"                        # Прописано, чтобы при обратной перемотке цвета не сбивались.
    "А сосед по домику все никак не хотел затихать."
    ...
    extend " Все порывался рассказать Шурику, какая замечательная девушка работает в библиотеке."
    ...
    "А потом, когда уже улегся, все мечтательно вздыхал и ворочался с боку на бок, и уснул далеко после отбоя."
    ...
    show 3500_sh normal_smile shirt at center with dissolve:
        ...
        pause 1.5
        linear 1 alpha 1
    "Шурик подождал еще минут тридцать, дожидаясь, когда дыхание у соседа успокоится, после чего встал и, не одеваясь, осторожно вышел на крыльцо, прихватив с собой одежду."
    hide 3500_sh with dissolve
    scene dct_ext_house_of_el_night
    show 3500_sh smile shirt:
        zoom 0.75 xcenter 0.6
    with slideawayup
    "Лагерь еще не уснул до конца. Еще горел свет в отдельных домиках, слышно было, как кто-то мелкий, ступая бесшумно, но выдавая себя сосредоточенным сопением, крадется от укрытия к укрытию."
    show 3500_sh upset shirt with dspr
    "Еще можно было нарваться и на вожатую, совершающую вечерний обход."
    ...
    extend " и, избегая чужого внимания, свернул направо, чтобы обогнуть темное здание административного корпуса с северной стороны и, через полосу молоденьких сосенок, выйти на дорожку, соединяющую музыкальный кружок с главной аллеей."
    ...
    th "Еще не хватало, чтобы увидели, как я из кустов выбираюсь."
    "Поэтому оставалось двигаться только вперед, используя для ориентировки исключительно внутренний компас потомственного горожанина, не бывавшего нигде, дальше городского парка с аттракционами, куда восьмилетнего Шурика водила мама."
    show sh rage pioneer close with dissolve_fast
    "Это было… нелегко."
    "Паутина липла к лицу, ноги спотыкались о невидимые кочки, ветки норовили сбить очки с лица и приходилось очки придерживать левой рукой, потому что со зрением минус шесть передвигаться без очков в ночном лесу остается только на ощупь."
    ...
    mi "Конечно-конечно, Сашечка. Я — могила! Но, пойдем, я тебя до домика провожу, вот тропинка. А то ты опять куда-нибудь заблудишься."
    "Приговаривая так, Мику убирала хвою, сор, мелкие веточки с одежды Шурика. Материализовав откуда-то носовой платок и поплевав на него, стерла паутину и попыталась оттереть следы смолы с лица."
    ...
    "Но отделаться от Мику не удалось, и Шурику, сопровождаемому японкой, пришлось идти по самой середине ярко освещенной аллеи, под ее бесконечное чириканье, привлекая внимание всех, кто хотел и мог это увидеть."
    ...
    mi "Ну все, хи-хи, Сашечка, теперь нас точно в парочку запишут."
    hide mi with dissolve_fast
    "Но Шурику было все равно."
    ...
    with dissolve
    mi "Вот и пришли, Сашечка. Ой, а там же ваша машина, мне Сережа про нее рассказывал, когда табуретку в кружке просил. А можно на нее посмотреть?"
    stop ambience fadeout 1
    ...
    mi "Нет-нет, Сашечка, я понимаю, что Сережа будет обижаться, поэтому буду делать вид, будто завтра я в первый раз все это вижу.{w} Понимаешь, для меня это очень важно.{w} А когда можно будет увидеть результаты?"
    ...
    "Потому что пока Мику рассматривала интерьеры кружка кибернетики, пока она хихикала, сидя внутри клетки: «Я обезьянка Мику, умею петь и играть на всех инструментах. Дорогая публика, подходите поближе, не стесняйтесь! — И, внезапно погрустнев. — Сашечка, неужели я и есть всего лишь такая забавная ученая обезьянка?»"
    ...
    with dissolve
    "Потом помог выбраться из клетки Мику, и машинально, совсем не задумываясь и не слыша себя, ответил на ее вопрос, заданный десять минут назад."
    ...
    extend " В общем, завтра, после подъема, встречаемся здесь."
    hide sh
    hide mi
    with dissolve
    show dct_int_clubs_male_night with dissolve
    $ persistent.sprite_time = "day"                        # Прописано, чтобы при обратной перемотке цвета не сбивались.
    "Они, вдвоем с притихшей Мику, прибрали все в кружке как было, заперли здание."
    ...
    $ night_time()                        # Прописано, чтобы при обратной перемотке цвета не сбивались.
    $ persistent.sprite_time = "night"
    "А Шурик, вернувшись к себе в домик, проспал без сновидений до самого подъема, даже не задумавшись о том, что уверенно добрался до него, тоже через лес, тоже самой короткой дорогой, так, как будто исходил тут все на тысячу рядов."
    stop music fadeout 2.5
    show black with dissolve
    window hide
    ...
    show unblink
    "Вожатая, додремывая в шезлонге, наблюдала за постепенным пробуждением лагеря и думала о том, что завтра прибывает опоздавший пионер, что придется селить Алису у себя, а опоздавшего — вместе с Максимом, в Алисином домике."
    show blinking
    th "Ох и ругаться будет Рыжая."
    "Небо с запада постепенно затягивало тучами, да еще и неприятный такой ветерок потянул с реки."
    stop sound fadeout 2.5
    th "Кажется, погода все портит, кажется, весь день сегодня будем сидеть по домикам."
    ...
    "Средний отряд, подгоняемый Ульяной, встал на свое место."
    ...
    with dspr
    "Как обычно, в эти минуты, разум у Ольги отключился, а текст пошел на полном автопилоте."
    ...
    with dissolve_fast
    me "Вот скажите, товарищи пионеры. А чего вы ждете от сегодняшнего праздника?"
    kids "Бега!\nПлавания!\nФутбола!"
    show d_sf smile pioneer with dspr
    "На слове «Футбол» Семен заинтересованно повернул голову в сторону кричавшего, но промолчал."
    kids "Поспать!"
    show mt sad panama pioneer
    show d_sf laugh pioneer
    show d_us laugh sport
    with dspr
    "Все засмеялись, Ольга поджала губы, а Семен одобрительно кивнул, показав большой палец."
    ...
    "Ничего Семен не сказал, потому что серые и низкие тучки уже начали сеять дождиком. Сперва мелким, но постепенно все более и более сильным и уверенным."
    "Пионеры уже ежились в своих тонких рубашках."
    ...
    with dissolve
    "Начиная с самого утра, когда поздоровалась с куда-то торопящейся соседкой, и выбежала навстречу Сергею, нет — Сереже."
    show int_house_of_sl_day:
    ...
    hide mi
    "И вот это: «как я рад», — еще добавило градус счастья. Даже торчащие у Сергея из кармана шорт полотенце и зубная щетка вызвали только умиление."
    ...
    "Зашла Мику, отчего-то грустная и серьезная, кивнула Сергею."
    mi "Женя, Сережа, не опоздайте на линейку."
    show ext_house_of_sl_day behind int_house_of_sl_day
    hide mi with dissolve
    show int_house_of_sl_day:
        pause 1.5
        linear 1 ycenter -0.5
    "Кажется, Мику едва сдерживала слезы, но это парочку сейчас не интересовало, парочка сейчас была самодостаточна."
    ...
    with dissolve
    "Романтическая линейка, когда можно стоять рядом и поминутно оглядываться друг на друга, и касаться случайно руками. Взяться за руки ни Сергей, ни Женя пока еще не решались."
    scene dct_ext_dining_hall_near_rain with pushleft
    $ persistent.sprite_time = "day"                          # Прописано, чтобы при обратной перемотке цвета не сбивались.
    "Романтическая пробежка под дождем к столовой, когда Сергей все норовил стащить с себя рубашку, чтобы прикрыть ею Женю."
    ...
    show dct_ext_library_rain:
        ...
        pause 3.4
        linear 1 xcenter 0.5
    "Они забрали у Семена накидки и, стараясь передвигаться по поребрику, чтобы не намочить ноги, побежали под дождем в библиотеку."
    ...
    hide d_el with dissolve
    "После этого Женя десять раз поправила на нем капюшон накидки, прежде чем выпустить из помещения библиотеки."
    ...
    "И вот, после того как Сергей убежал наконец в свой кружок, Женя включила настольную лампу и, выбрав книжку, соответствующую настроению — романтическую и теплую, устроилась за столом, забравшись с ногами на стул."
    ...
    $ persistent.sprite_time = "night"# Прописано, чтобы при обратной перемотке цвета не сбивались.
    "Почти невероятно, что кто-то из пионеров соберется в такой ливень в библиотеку."
    $ persistent.sprite_time = "day"
    show d_mz hope pioneer close at fleft with dissolve
    th "И как там Сережа? Не промок ли, пока бежал в свой кружок?"
    show d_mz sceptic pioneer close at fleft with dspr
    th "Надо будет, чтобы он телефон сюда провел. Из кружка в библиотеку."
    show d_mz smile pioneer close at fleft with dissolve_fast
    th "Тогда в следующий раз я буду знать, что с ним все в порядке."
    stop music fadeout 1
    show black with dissolve
    ...
    "Александр Трофимов-оригинал, заведующий лабораторией спецавтоматики, стоял у общежития, кутаясь в черное пальто от стылого, тянущего со стороны полигона, ветра, и ждал машину.{w} Хотелось закурить, но, по закону подлости, как только закуришь, машина обязательно подойдет, а курить в кузове Александр почему-то стеснялся."
    "\nМашины все не было, Александр уже собрался сунуть руку за сигаретами в карман, когда за углом загудело и, со стороны центральной улицы городка, выкатилась колонна из трех Уралов и двух БТР."
    show dct_dormitory_at_range_Ural_BTR with dissolve
    extend " Знакомый уже майор узнал Александра, махнул рукой, крикнув: «В третью машину!», — и открыл планшет, чтобы поставить там еще одну галочку.{w} Александр подхватил зажатый между ног портфель, подбежал к Уралу, кивнув прапорщику, сидящему рядом с водителем и, откинув полог тента, полез в кузов.{w} Его подхватили несколько рук, приняли портфель, помогли забраться самому, устроили на одной из поперечных лавок."
    scene dct_convoy_of_trucks with dissolve
    "Урал дернулся и покатил по улицам городка."
    ...
    "\nУрал куда-то ехал, поворачивая в несколько приемов на узких улочках.{w} Потом — короткая остановка, полог открыли и в кузов заглянул дежурный по КПП. Пробежал глазами по пассажирам и исчез, скрытый упавшим пологом.{w} Александр услышал: «Проезжайте», — и колонна, медленно набирая скорость, покатила в сторону аэродрома."
    ...
    show dct_road_bus_BTR:
        ...
        pause 1.5
        linear 1.5 alpha 1
    "\n И первое, что он увидел, был зад знакомого автобуса, торчащий из кювета.{w} Тут же стоял побитый БТР, около которого кто-то бинтовал кого-то. Но это было не важно, потому что на пассажирах автобуса не было ни царапинки, но и живых среди них тоже не было.{w} Некоторые еще дышали, но это ненадолго."
    ...
    window show
    mi "Сашечка, доброе утро! Ты идешь в кружок?"
    scene bg ext_washstand_day with dissolve
    "Шурик вздрогнул, непонимающим взглядом обвел умывальники."
    ...
    "\nПессимисты утверждали, что это не более, чем математическая конструкция, мол, где вы видели  нейтрино вживую, да еще и в составе кольца из себе подобных?{w} Мистики, всегда имеющиеся в подобных учреждениях, считали кольцо доказательством существования души, Бога, богов, переселения душ — в зависимости от исповедуемого учения.{w} А с точки зрения энтузиастов науки, такие кольца действительно существовали в некой сопряженной с нашей вселенной с иными физическими свойствами, и связь между вселенными осуществляется через пространственные вакуоли, подобные тем, где находились пионерский лагерь «Совенок» или поселок Шлюз, и принадлежащие одновременно обеим вселенным."
    ...
    window show
    "Холодная вода привела ненадолго Шурика в чувство. Ровно настолько, чтобы он умылся и дошел до домика."
    stop ambience fadeout 1
    window hide
    ...
    scene black with squares
    window show
    "Дальнейшие события дня в памяти Александра сохранились плохо, отрывками.{w} Вот он лезет внутрь автобуса, вот он берет из руки Яны-младшей бумажку с номером телефона, вот он сидит на асфальте перед автобусом, а вот он уже в салоне самолета."
    ...
    "О Шурике, испачканном, взъерошенном и непонимающем, куда он попал, выпавшем на нее из кустов, когда Мику запирала здание музыкального кружка.{w} О совершенно материнском желании этого Шурика умыть и почистить.{w} О визите в кружок кибернетики и загадочной установке, стоящей в центре кладовки, и занимающей почти всё свободное место."
    stop ambience fadeout 1
    ...
    with dissolve
    "Мику улыбнулась услышанным два дня назад словам Сережи: «Мы собираемся познать тайны человеческого мозга, Мику, — Сыроежкин, когда начинал говорить о науке, всегда говорил пафосно и с придыханием, — прочитать забытые воспоминания и понять механизмы мышления!»"
    ...
    show dct_railway_embankment_overcast:
        alpha 0
        linear 1 alpha 1
    extend " и надвигающаяся громада дамбы, на фоне черной тучи"
    ...
    with dissolve
    "И непонятное желание заботиться о Семене с Ульяной, оберегать их от всего плохого."
    $ persistent.sprite_time = "day"      # Прописано, чтобы при обратной перемотке цвета не сбивались.
    ...
    $ persistent.sprite_time = "day"
    "А потом нужно было сидеть неподвижно на вращающемся табурете, смотреть на медленно поворачивающиеся вокруг тебя стены и стараться ни о чем не думать."
    stop music fadeout 1
    ...
    "Что-то изменилось в нем за ночь, что-то появилось еще, что иногда диссонировало с образом рассеянного ученого, а что именно — Мику пока понять не могла."
    ...
    th "И взгляд его изменился: цепкий, слегка удивленный чему-то, и еще печаль пополам с тоскою, на самом дне взгляда."
    show mi serious pioneer far
    show sh serious pioneer far
    with dspr
    mi "Доброе утро еще раз, Сашечка. С тобой все в порядке?"
    ...
    show dct_clubs_male_comp_table:
        xcenter 0.5 ycenter 0.45
    with dissolve
    "Шурик скинул со стула стопку каких-то чертежей, сел перед монитором, и начал набивать на клавиатуре последовательность команд, читая появляющиеся ответы и удовлетворенно кивая или морщась, в зависимости от отклика."
    stop sound_loop fadeout 1
    ...
    with squares
    window show
    sh "Мику, садись на мое место. Сейчас я выйду и ты нажмешь вот эту кнопку."
    ...
    show ext_square_day behind adl_sh:
        ...
        pause 5.0
        linear 1 alpha 1
    "\n Чтобы не тратить время на ожидание Александр потребовал заглушить свое сознание Выключателем и жил в своем узле, в виде Шурика, такого же, как и все его копии в прочих узлах."
    ...
    "\n И вот, в первый цикл пребывания Семена в лагере бабы Глаши, Александр обнаружил, что ловушка сработала."
    hide 3500_sh with dissolve
    extend " Еще цикл ушел на создание робота."
    scene black
    show ext_clubs_day:
        zoom 1.1
    show sh cry pioneer:
    ...
    with dissolve
    extend " На одиннадцатый день второго цикла Семена, Александр, вставив в робота сработавшую ловушку, отпустил его и стал ждать результатов."
    hide ext_clubs_day
    hide sh
    with dissolve
    show d_jn:
    ...
    show dct_fog:
        alpha 0
        linear 1.5 alpha 1
    extend " Опять же, на одиннадцатый день цикла, вокруг поселка возникал туман — видимый результат взаимодействия двух вселенных. Робот должен был пройти сквозь туман, нейтринное кольцо, пойманное прибором-ловушкой, должно было клонироваться, и из тумана к роботу должен был шагнуть новый стерильный организм."
    show d_jn:
    ...
    with dissolve
    "\nИ еще, кошкоробот Яна, по своему, но подружилась с Семеном.{w} Все это привело к тому, что записанная в памяти робота программа действий оказалась стертой, кошкоробот поучил свободу воли и уехал обратно в родной лагерь, вместе с физруком, а Яна-человек, понятно, так и не появилась."
    scene dct_int_clubs_male_night_light_mon
    ...
    extend " После этого ему только и оставалось, что убивать себя каждый цикл, в надежде, что в Шурике активируется его собственная, Шурика, личность, которая навсегда сотрет Александра."
    stop music fadeout 1
    ...
    th "Я надеялся, что ты активируешься, тогда бы ушел спокойно, ты бы нашел применение моим знаниям."
    th "А сейчас, я не уверен, что ты перейдешь в следующий цикл не отключившись."
    th "Но ты, читая, стер мою память, перезаписав ее себе. То что я еще функционирую, это инерция, это скоро пройдет, как только ты ляжешь спать."
    show sh surprise pioneer far with dspr
    th "Спроси Семена, как это выглядит изнутри и снаружи, он видел и сам участвовал в таком, со всех трех сторон баррикады."
    ...
    mi "Сашечка, скажи. Сережа, он уже записывал свою память на твоей машине?"
    ...
    $ persistent.sprite_time = "day"                # Прописано, чтобы при обратной перемотке цвета не сбивались.
    sh "Да. Я все сделаю прямо сейчас, не беспокойся."
    stop ambience fadeout 1
    window hide
    show black with dissolve
    ...
    window auto
    el "Ты готов, Шурик?"
    sh "Давно уже.{w=0.5} Включай, да начнем запись."
    ...
    "Жужжал привод табуретки, дождь своими каплями колотил по стеклам, шуршал видеомагнитофон."
    ...
    show dct_el_in_cage:
        ...
        linear 1 alpha 1
    with squares
    "В отмеренный срок Сергей выключил установку, поменял в видеомагнитофоне кассету, помог, зацепившемуся рубашкой Шурику, выбраться из клетки, внес новую запись в лабораторный журнал, и сам полез внутрь установки."
    scene dct_int_clubs_male_rain
    ...
    extend " И все же, что-то было не так."
    ...
    el "Шурик, как хочешь, давай тебя. Или меня, мне все равно."
    show sh serious pioneer close with dspr
    ...
    with slideawayup
    "Дождь разошелся не на шутку: напротив крыльца, на всю ширину главной аллеи, от поребрика до поребрика, разлилась лужа, вся в желтых разводах пыльцы."
