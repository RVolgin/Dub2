...
label dct_coin_final:
    ...
    uv "Это всё потому, что я нематериализовавшееся подсознание и не ходячий портал, а всего-лишь кошка-мутант."
    ...
    un "Скажи, как ты думаешь, когда мой Семён проснется?"
    my "Скоро Лен. Не в этом цикле, но очень скоро."
    show un surprise pioneer close with dissolve_fast
    my "Он зайдет в лагерь, повернёт голову к клубам, увидит тебя и скажет одними губами: «Ленка! Я прорвался!», но ты его прекрасно услышишь и бросишься к нему на шею, завизжав так, что перепуганные кибернетики выскочат на крыльцо."
    ...
    th "Но уже скоро, чувствую, что от хорошего пинка, она проснется прямо сейчас и проснется безболезненно. Обойдёмся без пинков, всё должно быть естественно."
    ...
    show sh normal pioneer with dspr
    my "А скажи, я понимаю — робот. Могу догадаться, почему робот-девочка. Но кошка тут причём?"
