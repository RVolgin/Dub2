...
label dct_coin_final:
    ...
    my "Нет, не Семен. Я просто воспользовался на три-четыре часа его телом, пока он спит в автобусе."
    ...
    my "Между прочим, квартира в двухэтажке, сорок шестого года постройки, была на первом этаже, в ней было три комнаты, кухня и туалет с ванной. Только вот, чтобы помыться в горячей воде, приходилось топить дровяной титан и плита на кухне тоже оставалась дровяная. В ваш дом газ так и не провели. Это вам в копилку ваших общих воспоминаний."
    ...
    my "Ну к вам-то заглядывал не я один. Так что имена я уже знал. Так, несколько имен добавил в копилку и всё."
    ...
    my "Он зайдет в лагерь, повернет к голову к клубам, увидит тебя, и скажет одними губами: «Ленка! Я прорвался!», но ты его прекрасно услышишь и бросишься к нему на шею, завизжав так, что перепуганные кибернетики выскочат на крыльцо."
    show un cry_smile pioneer close with dspr
    my "Тебя спасать, между прочим, выскочат. Вот только ты к концу этого цикла забудешь всё, а вспомнишь уже потом, когда все произойдет."
    ...
    show d_us normal dress
    with dspr
    my "Есть много миров, кроме вашего. В том числе те, куда еще никто не заглядывал."
    ...
    show d_sf normal pioneer
    with dspr
    my "Все бы ты смогла. Решилась же тогда, в девяносто втором. И другие смогут или уже смогли, им просто нужно вспомнить."
    show d_us normal dress with dspr
    ...
    show sh normal pioneer with dspr
    my "А скажи, я понимаю — робот. Могу догадаться, почему робот-девочка. Но кошка тут причем?"
    ...
    my "Юля. Ее зовут Юля. И она человек."
