...
label dct_disposition:
    ...
    "По крайней мере, та пьеса, что они принесли в прошлый раз, была проглочена Леной за сутки, потом ещё три раза перечитывалась и породила массу карандашных рисунков-иллюстраций, самый доведенный до ума, из которых, сейчас ехал обратно, как подарок автору пьесы. Та, другая Мику — автор пьесы, обладала ещё и литературным талантом."
    ...
    show d_ma grin2 pioneer with dissolve_fast
    "Лена думала, как закруглить разговор. В конце-концов, Максим пока ещё только, не проснувшийся кандидат в старший отряд, и разъяснять тонкости взаимоотношений Рыжих с Семёном, постороннему человеку не хотелось."
    ...
    "Шурик запер клуб и, огибая здание, пошёл на свое вчерашнее место."
    stop sound_loop fadeout 1
    ...
    th "Почему Алиса куксилась, что всё, из цикла в цикл, одно и то же? Может, она просто видеть не умеет? Не знаю. И пионеры и природа, каждый цикл, но чуть-чуть разные."
    ...
    extend " А, когда режешь тупым, то ты напрягаешься, и у тебя нож обязательно сорвётся и попадёт по пальцам, как бы ты их не берегла."
    ...
    th "Привыкаю постепенно, вот уже и её кровать своими вещами занимаю, и белье на эту кровать брать на складе не стала. Но, всё равно, вечерами тоскливо. Хорошо хоть Ульянка каждый вечер, специально, поболтать заходит."
    show 3500_dv normal night2 0pt with dissolve_fast
    ...
    show white:
        alpha 1
        linear 1.5 alpha 0
    extend " И внутри каждого, спрятана своя Алиса, в чём-то абсолютно такая же, а в чем-то похожая, только на саму себя."
