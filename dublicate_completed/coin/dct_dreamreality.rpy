...
label dct_dreamreality:
    ...
    show black as black2:
        alpha 0.3
    with dissolve
    extend " Очень жаль, что большая семья, с кучей братьев и большой дом, и мама с папой, это всё — сон. А может и не сон, ведь, если есть мои двойники в других лагерях, то, может быть, где-то живет и настоящая девочка Славя, у которой есть мама с папой и свой дом."
    show anim prolog_1
