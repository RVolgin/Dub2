...
label dct_transitions:
    ...
    show dct_dream_sh_first_civilian at cright with dissolve
    ...
    show d_ma shy pioneer with dspr
    d_ka "А я вот сколько на гитаре не учусь — не получается. Как ты думаешь, может, у меня на горне получится?"
