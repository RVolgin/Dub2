...
label dct_sixhour:
    ...
    me "Алис, может, уведешь старшаков? А то им еще белье и форму получать, и домики, кстати, занимать."
    ...
    adl_sh4 "Семен.{w=0.4} Это ведь твой оригинал был заведующим лабораторией синтеза биосистем. Если хочешь Ульяне помочь — покопайся в памяти."
    ...
    adl_sh4 "Еще примерно час, если что понадобится, то обращайся. После — не приходи."
    stop music fadeout 1.5
