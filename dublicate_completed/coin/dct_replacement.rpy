...
label dct_replacement:
    ...
    "Со спортплощадки есть прямая дорожка по задам столовой и склада, но ну её, она сейчас раскисла, и тащить по ней груз, даже такой легкий, как вот эта второклассница, занятие архинеприятное."
    ...
    "Я ещё держу в голове остатки фантомных воспоминаний, внушенных Системой мне — спящему дубликату."
    show d_sf sad sport with dspr
    ...
    "Витька, вообще, последнее время, изменился. Дёрганный какой-то стал, как-будто Максим ему чем-то не нравится."
    ...
    sa "Всё, на всех хватит и никто не уйдет обиженным!"
    hide sl with dissolve
    pause 0.7
