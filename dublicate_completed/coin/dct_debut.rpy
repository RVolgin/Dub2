...
label dct_debut:
    ...
    us "Но ты бы, если мог, всё бы отключил, я знаю. Злился бы: «Почему опять я?!» Ругался нехорошими словами, но выключил бы этот рубильник."
    ...
    "А, потом уже, всплыло и подозрение, что и приглашают-то, исключительно, чтобы посмеяться над её неуклюжестью. Но все равно, отказалась Женя гораздо мягче, чем могла бы."
    ...
    mz "В библиотеку-то ещё зайдешь?"
    ...
    window show
    "Привет…{w=0.8} сестрёнка.{w} Раз уж Ульяны так между собой общаются, и я к тебе во сне так же обратилась, то и буду обращаться так же. Насколько я себя (тебя) знаю, ты не будешь против.{w} Кстати, это точно был сон? Потому, что нашим: Мику, Ульянке и Славе снилось тоже самое.{w} Но, что-то меня не туда понесло, начинаю сначала."
    ...
    show dct_fog:
        alpha 0
        linear 7 alpha 0.65
    "Поэтому, он сидел спиной ко всем, время от времени бормотал что-то про себя, шипел, когда пальцы хватали раскалённые выводы радиодеталей и концы проводов, да канифольный дым из-под жала паяльника, все больше и больше, наполнял комнату."
    ...
    show el normal pioneer at cleft:
        ...
        pause 5.1
        linear 1 alpha 1
    "Электроник закончил монтировать приемники и излучатели на каркас установки, Оксана оставила почти готовый корпус корабля на верстаке, дождалась Сергея и пошла с ним по главной аллее в сторону площади, продолжая что-то объяснять, иногда забегая вперёд и пятясь задом, чтобы видеть лицо Сергея."
    ...
    with dissolve
    "Еще одна драма: Максим за одним столом с Сашей и Мику, и от их стола тоже доносится смех и оживлённый разговор."
