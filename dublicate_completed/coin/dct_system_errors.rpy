...
label dct_system_errors:
    ...
    sh "\~ Это, правда, убьёт Яну-робота и нынешнего Шурика, но кому они нужны, кроме друг-друга? Они так, побочный результат сбоёв в экспериментах. \~"
    ...
    with dissolve
    "Легкий ветерок шевелил волосы, слышно было, как шлёпают волны о берег."
    ...
    "Мелкая улыбнулась в ответ, часто-часто закивала, качнулась опять к Семену, будто хотела, то ли ещё о чём-то спросить, то ли просто прижаться, но застеснялась и передумала."
    ...
    window auto
    "Семён и Ульяна, как и позавчера, сидели на крыльце спорткомплекса, смотрели на звезды, на блестевшую за аллеей и пляжем реку, на железнодорожный мост, раскинувшийся от края до края бухты."
