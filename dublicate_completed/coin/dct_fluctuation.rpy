...
label dct_fluctuation:
    ...
    "А, как только Мику ушла, Женя начала рвать этот формуляр. Пополам, потом ещё пополам, потом ещё, пока хватало сил в пальцах. Хотела выкинуть букет, но остановилась — цветы ни в чем, не были виноваты. Поэтому, в пустую молочную бутылку была налита вода, и цветы заняли место на столе."
    ...
    th "Или, это чернявый. Юморист из среднего отряда? Как его, Витька, кажется, пошутить решил? Какая разница? Может, мальчики тут и вовсе не причем. Девочки издеваются ещё изобретательнее. Проходили, знаем."
    ...
    th "А с соседкой мне, все же повезло. Хоть от неё подлостей можно не ждать, а её болтливость, я переживу."
    ...
    "Сердце дернулось, когда Максим перехватил взгляд Кати, но тут же и успокоилось, никак не реагируя на её спутника."
    ...
    "Максим побежал к флагштокам на свое место, и думал, почему он совершенно не обижается на Алису за её, казалось бы, грубость, и вчера, и сегодня? Что-то чувствовалось хорошее, за показной резкостью помощницы вожатой."
    ...
    "Было плохо. Кажется, Женя ему сегодня дала чётко и ясно понять, что его общество ей неинтересно."
    ...
    sa "Сережа, у тебя очень умные руки. Как бы мы тебя не отвлекали, они всё делают сами, правильно и красиво."
    # scene dct_ext_cliff_day with dissolve
    scene dct_ext_between_beach_and_boathouse_day with dissolve # Переделано, как и ранее
    ...
    "В общем, Алиса набегалась за сегодня на неделю вперед, и сейчас сидела в тренерской у Семёна и Ульяны, вытянув ноги и опиваясь чаем."
    scene dct_int_coaching_room2
    show d_us sad sport:
    ...
    "Лесная поляна, окруженная кустами; посреди поляны догоревший, но ещё дымящийся костер; вокруг костра лежат буквой П три больших бревна; на брёвнах, и рядом с брёвнами, всякие мелкие и не очень предметы, вроде связки ключей, рогатки, вожатской панамки, гитары, книги, отвёртки, ещё чего-то..."
    ...
    "Женя всё никак не могла заставить себя разобраться в кривых невозможного почерка и прочитать, что же там понаписал физрук на целых полстраницы, когда в дверь библиотеки постучали. Женя вздрогнула, закрыла папку и пошла к двери."
    ...
    "И вот, сейчас Максим искал Алису, чтобы проводить её до домика, под тем предлогом, что сам живет в соседнем. Пошёл по тропинке на голос и, уже перед аллеей, нечаянно подслушал разговор."
    dv "Завтра уходите?"
    me "Да, в пять утра."
    ...
    me "Сейчас налегке пойдем, а Рыжик подлечит, если что. Так, что завтра туда, а послезавтра утром вернёмся."
