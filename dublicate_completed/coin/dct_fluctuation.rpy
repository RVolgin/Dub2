...
label dct_fluctuation:
    ...
    "Максим побежал к флагштокам на свое место и подумал — почему он совершенно не обижается на Алису за её, казалось бы, грубость и вчера, и сегодня? Что-то чувствовалось хорошее за показной резкостью помощницы вожатой."
    ...
    "Людей на рисунке не было. Только из кустов выглядывала чья-то намеченная несколькими штрихами голова. Но только намеченная, так что не поймёшь, молоденькая девушка это с забавной прической или крупная кошка. Женя перевернула страницу."
