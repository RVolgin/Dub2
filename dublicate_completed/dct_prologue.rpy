...
label dream1:
    ...
    "Голос 1" "...значит, так и поступим. Давайте тогда ещё раз проговорим всё." #Больше этих участников нигде не будет, так что можно их не задавать.
    ...
    "Голос 1" "Подтверждаю."
    "Голос 4" "Спасибо, я сама. А во-вторых, если отключить циклы, то здесь половина, чей мозг ещё не развит, скатится до уровня животных, {w}а вторая половина — дети от семи до семнадцати, что бы у них в голове спрятано ни было."
...
label morning_zero:
    ...
    with dissolve
    "{i}Денег хватает на еду и одежду, большего и не надо. А окружающий мир давно уже не интересует. На винчестере скачанные и непросмотренные фильмы, непрослушанная музыка, непрочитанные книги, непройденные игры.{/i}"
