...
label morning_zero:
    ...
    "Сон очень реалистичный. Даже запахи в нём присутствуют: пыли с улицы, дерева от столов, женских духов и табака. И ветерок из приоткрытого окна холодит щёку."
    ...
    "Славя — первая, кто всегда меня встречает по приезде, и так получилось, что она, сама не зная того, пришла меня проводить."
