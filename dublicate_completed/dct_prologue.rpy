...
label dream1:
    ...
    "Голос 1" "Энергия - с внешней подпиткой проживём без ограничений, без внешней подпитки придётся необитаемые узлы отключать; {w}снабжение - синтезаторов хватит лет на двести."
    ...
    "В разговор вступает мужчина. Этот говорит так, как будто только что думал о чём-то своем. Не совсем впопад и после небольшой паузы."
    "Голос 1" "Ты тоже намерен жить, как...{w} пионеры?"
    "Голос 2" "Уж сколько раз говорилось, да. И, давайте оставим эту тему. У меня всё."
    ...
    "Голос 3" "Ну, одного как-нибудь отследим. У меня тоже всё."
    ...
    "Голос 4" "Во-первых, есть риск, что всё посыпется."
    "Голос 1" "Подтверждаю."
    ...
    "Голос 1" "В таком случае никого не задерживаю. Вы были не самые дисциплинированные подчинённые, но вы оказались очень хорошими людьми. Всем спасибо."
    play sound dct_sfx_chair
    "Слышно, как двигаются стулья, слышно как люди встают и идут к выходу."
    play sound sfx_open_door_1 
    "Голос 1" "Послезавтра расстаёмся. Завтра собираем чемоданы. А сегодня вечером жду всех в столовой. Приглашаю всех, даже тех, кто проглядел дыру в окне."
    "Голос 3" "Если бабушка зовёт в столовую, значит будет вкусно. Рекомендую."
...
label morning_zero:
    ...
    show dct_intro_xx_grayscale_small:
        pos(0.1,0.35)
        rotate(-8)
    "Текущий год в этой реальности — две тысячи седьмой, действующее лицо — Персунов Семён Семёнович, двадцати семи лет, незаконченное высшее, эникейщик, живет один."
    play sound dct_sfx_solo_card
    ...
    show dct_d2_mirror_grayscale_small with dissolve:
        pos(0.4,0.3)
        rotate(-4)
    "Звучит как бред, но это так. И этот вариант мне кажется, несмотря на всю его бредовость, гораздо более правдоподобным. Даже несмотря на то, что в этом варианте реальности присутствуют как минимум трое моих двойников и намеки одного из них на множество таких лагерей."
    play sound dct_sfx_solo_card
    ...
    "Осторожно встаю, стараясь не скрипеть кроватью. Прислушиваюсь к дыханию вожатой - нет, все тихо. Начинаю одеваться. Если проснётся, то скажу, что на пробежку."
    ...
    with dissolve
    "{i}Даже на игры уже не хватает сил и желания. Иногда еще аниме глянет, а ведь когда-то был фанатом. Социофоб. Хикка. Как ещё назвать? Не знаю, сами придумайте.{/i}"
    ...
    "{i}И ещё, почему на остановку пришел именно этот автобус - древний, дребезжащий и разваливающийся на ходу ЛиАЗ, которых уже почти не осталось?{/i}"
    $ renpy.pause(4, hard=True)
    stop sound
    ...
    $ prolog_time()
    "{i}Представьте себе: Семён Персунов образца декабря две тысячи седьмого года, садится вечером в ЛиАЗ в своем городе, чтобы уехать на встречу с однокурсниками.{/i}"
    ...
    "{i}По дороге Семён засыпает, а просыпается жарким июньским днем восемьдесят непонятного года в Икарусе, стоящем перед воротами пионерского лагеря.{/i}"
    stop sound
