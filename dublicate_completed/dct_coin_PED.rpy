...
label dct_sixhour_ped:
    ...
    scene dct_ext_buses_filled with dct_fade
    $ set_mode_nvl()
    window show
    ...
    scene bg ext_square_sunset with dct_fade
    $ sunset_time()
...
label dct_transitions_ped:
    ...
    scene bg int_clubs_male2_night with dct_fade
...
label dct_disposition_ped:
    ...
    scene dct_ext_between_beach_and_boathouse_sunset with dissolve2
    $ set_mode_adv()
    $ sunset_time()
    $ persistent.sprite_time = "sunset"
...
label dct_foreign_land_ped:
    ...
    scene dct_dormitory_at_range with squares
...
label dct_replacement_ped:
    ...
    scene bg ext_dining_hall_away_day with blinds
