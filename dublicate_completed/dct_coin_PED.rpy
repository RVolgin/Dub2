...
label dct_sixhour_ped:
    ...
    "\nКак и всегда… «Вы умерли, и у вас в запасе вечность!» — только это меня и утешает. Я про то, что я умер.{w} Хорошо, я, как и всегда, потерплю до сегодняшней ночи, не буду нагонять жути и мрачных мыслей на «пионеров». В конце концов, они дети, сколько бы им ни было лет на самом деле и сколько бы ни было лет их оригиналам."
    "\nИ чтобы не портить смену в пионерском лагере той копии-заглушке, с которой я делю это тело, надо произвести на товарищей по отряду более-менее приятное первое впечатление. Пусть я буду непривлекателен, но хотя бы забавен и безобиден. Как и всегда… «Разрешите представиться, Паганель, версия неизвестно какая по счёту, стереотипная». {w}Плохо то, что моя память и память той копии практически не пересекаются. Он даже в более выгодном положении, чем я. Я о нём вообще ничего не знаю, а у него хотя бы мои имя, фамилия и все мои способности.{w} А может быть, ему роль ДʼАртаньяна больше по душе?"
    ...
    $ set_mode_nvl()
    "Пока Сыроежкин не проснулся, надо сообразить, как избежать диалога с Глафирой Денисовной. Потому что она опять начнёт…{w} Правда, я не видел её десяток циклов, не меньше. Неужели всё? Интересно, как Система это обыграла?{w} Нет, ничего интересного, повариха и повариха — кто её запоминает, кроме активированных? Приехала заглушка — копия или микс из резерва."
    "\nГосподи, ну когда же я сдохну?{w} Когда мой сосед по этому телу разовьётся настолько, что захватит над ним контроль целиком? Как же мне надоело просыпаться."
    ...
    us "Александр, за что вы с ним так поступили? За что вы с {b}ними{/b} так поступили?"
    ...
    "А Александр сидел перед включённым компьютером и набивал по памяти длинную последовательность знаков, лишённую видимого смысла."
    play sound_loop sfx_computer_noise fadein 0.5
    "Нажал «Ввод», подождал, пока на экран не выползет таблица, просмотрел её, удовлетворённо кивнул, достал наушники и подключил их к компьютеру."
...
label dct_transitions_ped:
    ...
    scene dct_int_house_of_mi_day with dct_fade
    play ambience ambience_int_cabin_day fadein 1
    ...
    "Физрук сказал после линейки, что зайдёт попозже, когда всё успокоится и толпа схлынет, но ему нужны были спортивные методички, присланные из райцентра."
    ...
    "Никто не ответил, но кто-то всё же зашёл."
    ...
    "Женя приготовила на лице неприязненное выражение (само приготовилось, чего уж там, не владела Женя актёрским мастерством), набрала воздуха, чтобы высказать пришельцу всё, что думает («Говори чётко! Проси мало! Уходи быстро!»), и замерла, не зная, как реагировать."
    ...
    "На барьер конторки шлёпнулись ручка и формуляр."
    ...
    "И жёлтые глаза смотрели на Электроника совершенно без злобы. С досадой — да, смущённо — да, но без злобы, а даже и с интересом."
    ...
    show cg d4_el_wash:
        ...
        pause 1
        linear 1 alpha 0
    "Сыроежкин махнул рукой, подошёл к игрокам, снял галстук, снял рубашку, чтобы не испачкать, аккуратно сложил их на ближайшую лавочку и, как и остальные, оставшись в одних шортах, включился в игру."
    hide cg d4_el_wash
    hide el
...
label dct_fluctuation_ped:
    ...
    scene dct_ext_square_profile_view_day with dct_fade # Возможно, этот ракурс площади более уместен?
    ...
    "Был ещё тромбон, но его столько раз роняли, что однажды он отказался собираться и так и лежал в кладовке в виде двух половин."
    ...
    "Максим повернулся, чтобы посмотреть, из-за чего так дёрнулась девочка, и улыбнулся — со стороны столовой к нему быстрым шагом шла Алиса."
    ...
    scene dct_ext_between_beach_and_boathouse_day with dct_fade # Пока сделаем так. И вряд ли потом будем переделывать
    ...
    with dissolve
    "И вот, когда Электроник где-то через час после завтрака в нервной трясучке прибежал к библиотеке, и… Да что теперь вспоминать? В общем, отлуп, бессмысленный и беспощадный. {w}«За книгами приходи, раз уж записывался», — сказано было вдогонку, равнодушно, как к стотысячному посетителю за сегодня. Это если без подробностей, которые вспоминать не хотелось."
    window auto

    scene dct_ext_between_beach_and_boathouse_day with pixellate # Переделано, как и ранее
    $ set_mode_adv()
    ...
    scene dct_ext_glade_behind_clubs_day with dct_fade # Пусть будет такой.
    play sound_loop ambience_camp_center_day fadein 1
    ...
    scene bg int_library_night with dissolve_fast #приглушённый звук дискотеки
...
label dct_disposition_ped:
    ...
    show dct_camp_hustle_to_the_left behind dct_dream_veil # Псевдокартинка: Рандомные лагерные места сменяют друг друга
    ...
    "\nШурик зачеркнул «лабораторию» и написал «кружок». Вроде бы всё.{w} Но тут мысли Шурика перебили.\n"
    stop music fadeout 1
...
label dct_debut_ped:
    ...
    show d_us normal dress behind un:
        xzoom -0.5 yzoom 0.5 xcenter -0.1 ycenter 0.66
...
label dct_d7_d5_ped:
    ...
    extend " Мрачная и задумчивая."
    extend " И музыка у неё выходила такая же — мрачная и задумчивая."
    ...
    extend " Вчерашнее письмо от Алисы-двойника не шло из памяти: «Я хочу рискнуть и увидеться… Мы должны сравнить наши детские воспоминания».\n"
    ...
    "Край сцены начал резать стопы, девушка перебралась ближе к углу и уселась, вытянув ноги вдоль досок покрытия и опираясь спиной о вертикальное начало половинки купола."
    ...
    scene dct_ext_beach_barhan
    show d_ka p2 serious pioneer with dissolve:
        zoom 0.825 xcenter 0.2 ycenter 0.76
    with dissolve
    "А тут ещё Катерина обращает на себя внимание."
    # show d_ka p3 serious pioneer2swim with dissolve_fast:
    show d_ka_p3_to_d_ka_p4 as d_ka with dissolve_fast:     # Псевдокартинка, на которой спрайт d_ka p3 через 3,5 секунды превращается в d_ka p4
        pause 0.5
        ease 2 xcenter 0.65
    ...
    show d_ka p4 angry pioneer2swim with dissolve_fast:
...
label dct_foreign_land_ped:
    ...
    # "Были там ещё, конечно, и другие слова, и в результате парочка, собирающаяся распасться, не успев сложиться, сидела на скамье. Всё там же, в конце библиотечной аллеи, спрятавшись от всех за статуей читающего пионера, каждый на своём конце, и молчали, отвернувшись друг от друга."   # По канону
    ...
    #play sound "<from 2.07 to 4.70>" + dct_sfx_discharge
    stop ambience fadeout 2
    ...
    play sound_loop2 "<from 1.9 loop 3.5>" + dct_sfx_steps_in_swamp fadein 0.8
    ...
    hide d_el
    with dissolve
    show dct_ext_dining_hall_near_rain behind dct_int_dining_hall_people_rain
    ...
    "Сыроежкин был влюблён, ему было не до того, и он был ограничен Системой, которая слегка корректировала приоритеты в его восприятии. Поэтому он не замечал ни отсутствия энтузиазма в репликах Шурика, ни того, что тот откровенно тянет время, интересуясь подробностями Жениной биографии."
    ...
    "Он даже на отношения между Сергеем и Женей смотрел с той точки зрения, чтобы они не мешали занятиям в кружке."
...
label dct_system_errors_ped:
    ...
    scene bg int_library_day with dct_fade
    ...
    "А послезавтра будет «День Маяковского», значит, русские классики отправятся на свои места, а их место займёт классик советский."
    ...
    show d_sf sad pioneer with dspr
    "И замолчал. А через три минуты, перечитав ещё раз написанное, сложил листки бумаги пополам, спросил у Жени, есть ли у той в хозяйстве конверты, получил конверт из обёрточной бумаги, спрятал в него написанное, собрался заклеить, но передумал."
...
label dct_dreamreality_ped:
    ...
    d_ma "\~ А потом лампочка мигнёт в третий раз, шар сожмётся ещё, и останется только Алиса, а всё прочее исчезнет. \~"
    window hide
    hide 3500_dv
    $ renpy.music.set_volume(1.0, delay=0, channel='ambience')
    show black with dissolve_fast:
...
label dct_horizontal_transport_ped:
    ...
    show d_ma smile pioneer at right:
        yalign 0.02
    with dissolve
    "Максим чуть отстал от проскользнувшей вперёд Сашки и, может быть, даже так бы и прождал ту на веранде, не заходя в помещение, если бы не…"
    show d_ma surprise pioneer with dspr
    stop sound_loop fadeout 1
