...
label d_duo:
    ...
    dreamgirl "Ульянка, поднырнув под створки хозяйственных ворот лагеря, выбралась на волю и решала, как ей реализовать полученные возможности."
    ...
    dreamgirl "Но пока Ульянка думала и крутила головой вправо-влево, выбирая между реальными и соблазнительными малинником и рекой, и недостоверной, но зато романтично-загадочной кошкодевочкой, жизнь всё решила за неё."
    ...
    dreamgirl "Вторым на поляну вышел парень лет двадцати пяти, высокий, худой, с копной каштановых волос, зачёсанных назад, в вожатской форме, но без галстука, только с каким-то чёрным шнурком на шее, прячущимся под рубашкой, и с выгоревшим на солнце, а когда-то голубым рюкзаком за плечами."
    ...
    dreamgirl "Запах тайны и приключений был так силён, что Ульянка, едва подождав, пока пришельцы отойдут от ворот, полезла за ними следом и так и сопровождала парочку до самого медпункта, стараясь не пропустить ни одного слова."
    ...
    dreamgirl "Вреда от него, впрочем, не было, а дразнить его было неинтересно, это Ульяна выяснила в первый же день — Толик жил в каком-то своём мире и на окружающих просто не реагировал."
    ...
    dreamgirl "Он всё так же придурковато улыбался и пускал слюну, но Ульянка успела поймать мелькнувшее выражение глаз Толика, очень жёсткое и безжалостное; и что-то чёрное мелькнуло в его руке, мелькнуло и исчезло."
    ...
    dreamgirl "И похоже, слова парня подействовали. Если пришельцев тут и не ждали, то быстро оценили и сочли неопасными — да что там, своими их сочли."
...
label d_comission:
    ...
    dreamgirl "Порой казалось, что она знала, о чём её спросят, раньше, чем собеседница формулировала вопрос; порой Ульяна-маленькая угадывала реплики гостьи. Только иногда гостья замирала, будто вспоминая что-то неприятное, и отвечала так, будто это неприятное в своих ответах обходила."
...
label d_lake:
    ...
    show d_us smile sport with dspr
    dreamgirl "А потом посмотрела на Ульяну-младшую, на Алису, которые всё порывались открыть рот и спросить, например, о странностях в поведении некоторых гостей лагеря, улыбнулась своим мыслям и предложила сама:"
    show us normal pioneer with dspr
...
label d_persunovs:
    ...
    with hpunch
    us "Нет, она не одна!"
    dreamgirl "Ульянка, всё-таки догнавшая Алису, протиснулась мимо неё в тренерскую и по-хозяйски огляделась."
...
label insomnia:
    ...
    hide dv with moveoutleft
    dreamgirl "А Ульяна сначала прыгает на месте от избытка эмоций и машет Семёну обеими руками, как спортсмену на стадионе, а потом прекращает прыгать, опускает левую руку, а правой машет всё медленнее и наконец замирает, встав на цыпочки с поднятой правой рукой, прощаясь."
    dreamgirl "И на душе — там, во сне — становится одновременно и радостно за Семёна, потому что уже ясно, что всё у него получится; и грустно, что он уплывает; и обидно, что не позвал с собой и даже не попрощался."
    ...
    dreamgirl "А ещё не давало уснуть письмо Глафиры Денисовны. По словам Семёна, пакет с письмом ему был вручён за один цикл до смерти профессора Андрейко."
    stop ambience
    ...
    dreamgirl "Кстати, нужно было показать это письмо ещё и Семёну, тем более что там была пара абзацев, обращённых к нему лично."
    stop ambience
...
label last_letter:
    ...
    play ambience ambience_int_cabin_day
    play music music_list["i_want_to_play"]
    dreamgirl "Вожатая только что вернулась от умывальников и сейчас, всё ещё дрожа от ледяной воды, переодевалась из спортивного костюма в форму."
    ...
    with dissolve
    play ambience ambience_camp_center_day
    dreamgirl "Пока шёл, раскланивался направо и налево — вот и плюс от посещения линейки. Потому что в первый день очень хотелось с каждым встречным поздороваться, а фактически выходило, что этот встречный — совсем незнакомый пионер."
    ...
    stop music fadeout 2
    dreamgirl "И Семён — нет, Сенька, сидящий на планшире наветренного борта лицом к выскочившей на берег погоне и всё-таки поднявший на прощание левую руку — совершенно искренне, без всякой издёвки поднявший."
    ...
    mi "Ой, да можно, конечно. Все равно она тут никому не нужна. Только, Сенеч… Семён, поиграешь ещё? Я всё-таки хочу понять, откуда мне твоя манера знакома."
    show d_sf normal pioneer with dspr
...
label routine_:
    ...
    dreamgirl "На столе лежал журнал мод. «Советская модница». Не то чтобы у Ульяны очень болела об этом голова, но она всё же была девочкой и, отложив в сторону тетрадь, потянулась к журналу."
...
label cracks_:
    ...
    dreamgirl "Поэтому, когда всё закончилось, а спина его украсилась двумя рядами проволочных шипов, Семён осторожно повернул голову, поймал взгляд Ульяны и сказал ей одними глазами: «Ты молодец, Рыжик»."
    dreamgirl "Виола осторожно накрыла Семёна простынёй, перевернула песочные часы и уселась, развернув стул спинкой к столу. Приглашающе кивнула Ульяне: садись, мол, хоть на вторую кушетку."
    ...
    dreamgirl "Система и создатели наградили её способностями к музыке, вокалу, танцам, и всё это воспринималось обитателями как должное и было для здешнего мира естественно."
    dreamgirl "А тут впервые Мику сделала что-то такое, что не было ей подарено извне, что-то, что вышло изнутри неё ценой нервных клеток, ценой зверского голода, ценой головной боли и жуткой опустошённости. Что-то такое, что она довела до конца."
    ...
    show d_us normal dress at cright:
        ypos -0.05
    with moveinleft
    dreamgirl "Библиотека оказалась обитаема: в библиотеке горел свет, и сквозь приоткрытое окно был отчётливо слышен стук пишущей машинки и спорящие о чём-то голоса."
...
label artists_:
    ...
    hide d_sf with dspr
    show mi normal pioneer with dspr
    dreamgirl "Будущие звёзды больших и малых академических театров несколько секунд молчали, глядя на администрацию театра, а потом Катя, пересилив накатившее волнение, спросила:"
...
label shear_deformations:
    ...
    dreamgirl "Когда Семён вернулся перед ужином в тренерскую, там ничего не изменилось. Его Ульяна всё так же сидела за столом, поджав под себя одну ногу, всё так же грызла колпачок ручки, всё так же периодически запускала пятерню в свои волосы."
    ...
    dreamgirl "Искать ничего не пришлось. Всё это барахло лежало именно там, под тем кустом, куда его сунула в своих, как она считала, фантазиях Алиса."
    stop ambience
...
label splinters_:
    ...
    dreamgirl "Семён огляделся — никто не видит? Разбежался и отправил мяч к центру поля."
...
label strange_memory:
    ...
    sl "Пойдем. Ни разу ещё не бывала за забором, всё некогда. Только на остановке."
    play sound_loop dct_sfx_steps2
    show d_sl shy pioneer with dspr
    ...
    dreamgirl "Семён когда-то делился с ней своим опытом общения с ещё не проснувшимися пионерами, которые вот-вот проснутся. Но всё вылетело из головы."
...
label dots_over_yo:
    ...
    dreamgirl "До ужина оставалось ещё целых три часа, и в бедном на события «Совёнке» всё замерло."
    ...
    play ambience ambience_camp_center_day
    dreamgirl "Алиса учила роль. Ей всё-таки навязали роль Оксаны Сергеевны, и сейчас, когда Ульянки не было, она ходила по домику и повторяла реплики."
    ...
    with dspr
    dreamgirl "У клубов четвёрка упёрлась в обоих кибернетиков."
...
label return_bus:
    ...
    me "Вот и всё, Рыжик. Вот и закончилась эпоха. Хотя… нет, ещё не все. Где же он у меня?.."
    stop ambience
    ...
    voice "Нет. Когда я жила одна — мне было всё равно; когда мне оставляла еду та женщина, которая сейчас уехала — нам тоже было все равно."
